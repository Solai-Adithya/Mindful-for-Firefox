!(function (a) {
    ...
    function (a, b, c) {
        ...
        var d = c(2),
            ...
            r = c(388),
            s = t(r),
            u = new e.default(document.querySelector("article.fk-editable"), { plugins: [new g.default(), new s.default(), new i.default(), new m.default(), new o.default(), new q.default(), new k.default()] });
        window._editor = u;
    },
    function (a, b, c) {
        "use strict";
    ...
    function (a, b, c) {
        ...
        function i(a, b) {
            ...
            if (a.constructor === String) {
                ...
                return 0 === d.length ? (console.warn("'%s' did not match any elements", a), !1) : i(d, b);
            }
        ...
        (i.createDocument = function () {
            return "undefined" == typeof i.currentDocument && (i.currentDocument = e.default.create()), i.currentDocument;
        }),
            (i.debug = g.default),
            (window.FrontKit = i);
    },
    function (a, b, c) {
        ...
        var d = (function () {
            ...
            G = (function (a) {
                function b() {
                    A(this, b);
                    var a = B(this, (b.__proto__ || Object.getPrototypeOf(b)).call(this));
                    return (a.editors = []), (a.activeEditor = null), (a.lastActiveEditor = null), (a.ui = new s.default(a)), a.bindEvents(), a.detectFeatures(), E("Created new Document instance, %o", a), a;
                }
                return (
                    C(b, a),
                    d(
                        ...
                        [
                            {
                                key: "createEditor",
                                value: function (b, c) {
                                    var d = (0, l.default)(this.editors, function (a) {
                                        return b === a.el;
                                    });
                                    if (d) return console.warn("%o already has a FrontKit Editor instance attached to it", b), d;
                            ...
                            },
                            {
                                ...
                                value: function (b) {
                                    var c = b,
                                        d = 0;
                                    return (
                                        b.constructor === String && (c = document.querySelectorAll(b)),
                                        (0, j.default)(this.editors, function (a) {
                                            (0, n.default)(c, a.el) && (a.destroy(), d++);
                                        }),
                                        d
                                    );
                                },
                            },
                            {
                                ...
                                value: function () {
                                    var b = this,
                                        c = this.delegateEventToActiveEditor.bind(this);
                                    document.body.addEventListener("mouseup", c),
                                        window.addEventListener("click", c),
                                        window.addEventListener(
                                            "resize",
                                            (0, f.default)(function (a) {
                                                c(a), b.lastActiveEditor !== b.activeEditor && b.lastActiveEditor.emit("resize", a);
                                            }, F)
                                        ),
                                        window.addEventListener(
                                            "scroll",
                                            (0, f.default)(function (a) {
                                                c(a), b.lastActiveEditor !== b.activeEditor && b.lastActiveEditor.emit("scroll", a);
                                            }, F)
                                        ),
                                        window.addEventListener("mousemove", (0, h.default)(c, F)),
                                        D.on(window, c);
                                    var d = this;
                                    new w.default({
                                        selectionChange: function (b, c) {
                                            d.activeEditor && d.activeEditor.emit("selectionchange", b, c);
                                        },
                                        selectionChangeEnd: function (b, c) {
                                            d.activeEditor && d.activeEditor.emit("selectionchange.end", b, c);
                                        },
                                    });
                                },
                            },
                            {
                                ...
                                value: function (b) {
                                    var c = b.type;
                                    this.activeEditor && this.activeEditor.emit(c, b);
                                },
                            },
                            {
                                key: "setActiveEditor",
                                value: function (b) {
                                    (this.activeEditor = b), this.emit("editorChange", b), b && (this.lastActiveEditor = b);
                                },
                            },
                            {
                                key: "detectFeatures",
                                value: function () {
                                    ...
                                    (b.match(/iPad/i) || b.match(/iPhone/i)) && document.documentElement.classList.add("fk-touch-device-with-native-bubble");
                                },
                            },
                            {
                                key: "use",
    ...
    function (a, b, c) {
        function j(a, b, c) {
            ...
            return (b = f(b) || 0), d(c) && ((q = !!c.leading), (r = "maxWait" in c), (l = r ? h(f(c.maxWait) || 0, b) : l), (s = "trailing" in c ? !!c.trailing : s)), (B.cancel = z), (B.flush = A), B;
        }
        var d = c(6),
            e = c(7),
            f = c(10),
    ...
    function (a, b, c) {
        function l(a) {
            ...
            a = a.replace(g, "");
            var c = i.test(a);
            return c || j.test(a) ? k(a.slice(2), c ? 2 : 8) : h.test(a) ? f : +a;
        }
        var d = c(6),
            e = c(11),
            f = NaN,
    ...
    function (a, b, c) {
        function j(a) {
            return null == a ? (void 0 === a ? h : g) : ((a = Object(a)), i && i in a ? e(a) : f(a));
        }
        var d = c(13),
            e = c(14),
            f = c(15),
    ...
    function (a, b, c) {
        function g(a, b, c) {
            ...
            return e(c) && ((g = "leading" in c ? !!c.leading : g), (h = "trailing" in c ? !!c.trailing : h)), d(a, b, { leading: g, maxWait: b, trailing: h });
        }
        var d = c(5),
            e = c(6),
    ...
    function (a, b, c) {
        function l(a, b) {
            var c = f(a),
                ...
                p = o.length;
            for (var q in a) (!b && !k.call(a, q)) || (n && ("length" == q || (l && ("offset" == q || "parent" == q)) || (m && ("buffer" == q || "byteLength" == q || "byteOffset" == q)) || h(q, p))) || o.push(q);
            return o;
        }
        var d = c(26),
            e = c(27),
    ...
    function (a, b, c) {
        ...
        var d = c(12),
            ...
            E = {};
        (E[v] = E[w] = E[x] = E[y] = E[z] = E[A] = E[B] = E[C] = E[D] = !0), (E[g] = E[h] = E[t] = E[i] = E[u] = E[j] = E[k] = E[l] = E[m] = E[n] = E[o] = E[p] = E[q] = E[r] = E[s] = !1), (a.exports = F);
    },
    function (a, b) {
        function d(a) {
    ...
    function (a, b, c) {
        function h(a) {
            if (!d(a)) return e(a);
            var b = [];
            for (var c in Object(a)) g.call(a, c) && "constructor" != c && b.push(c);
            return b;
        }
        var d = c(40),
            e = c(41),
    ...
    function (a, b, c) {
        function e(a, b) {
            return function (c, e) {
                if (null == c) return c;
                if (!d(c)) return a(c, e);
                for (var f = c.length, g = b ? f : -1, h = Object(c); (b ? g-- : ++g < f) && e(h[g], g, h) !== !1; );
                return c;
            };
        }
        var d = c(43);
    ...
    function (a, b, c) {
        function h(a, b) {
            ...
            if (c instanceof d) {
                var h = c.__data__;
                if (!e || h.length < g - 1) return h.push([a, b]), (this.size = ++c.size), this;
    ...
    function (a, b, c) {
        function g(a, b, c, h, i) {
            return a === b || (null == a || null == b || (!e(a) && !f(b)) ? a !== a && b !== b : d(a, b, c, h, g, i));
        }
        var d = c(90),
            e = c(6),
            f = c(16);
    ...
    function (a, b, c) {
        function r(a, b, c, p, r, s) {
            var t = i(a),
                ...
                v = n,
                w = n;
            t || ((v = h(a)), (v = v == m ? o : v)), u || ((w = h(b)), (w = w == m ? o : w));
            var x = v == o,
                y = w == o,
                z = v == w;
            if (z && j(a)) {
            ...
            if (z && !x) return s || (s = new d()), t || k(a) ? e(a, b, c, p, r, s) : f(a, b, v, c, p, r, s);
            if (!(c & l)) {
        ...
        function i(a, b, c, i, j, k) {
            ...
            for (k.set(a, b), k.set(b, a); ++p < m; ) {
                ...
                if (r) {
                    if (
                        !e(b, function (a, b) {
                            if (!f(r, b) && (s === a || j(s, a, c, i, k))) return r.push(b);
                        })
                    ) {
                        q = !1;
                        break;
    ...
    function (a, b, c) {
        function y(a, b, c, d, w, y, z) {
            switch (c) {
                ...
                case u:
                    return !(a.byteLength != b.byteLength || !y(new e(a), new e(b)));
                case l:
                case m:
                case p:
                    return f(+a, +b);
    ...
    function (a, b, c) {
        var d = c(103),
            ...
            u = j(h),
            v = i;
        ((d && v(new d(new ArrayBuffer(1))) != p) || (e && v(new e()) != k) || (f && v(f.resolve()) != m) || (g && v(new g()) != n) || (h && v(new h()) != o)) &&
            (v = function (a) {
                var b = i(a),
    ...
    function (a, b, c) {
        function m(a, b) {
            return g(a) && h(b)
                ...
                : function (c) {
                      var g = e(c, a);
                      return void 0 === g && g === b ? f(c, a) : d(b, g, k | l);
                  };
        }
        var d = c(89),
            e = c(111),
    ...
    function (a, b, c) {
        function h(a, b) {
            if (d(a)) return !1;
            var c = typeof a;
            return !("number" != c && "symbol" != c && "boolean" != c && null != a && !e(a)) || g.test(a) || !f.test(a) || (null != b && a in Object(b));
        }
        var d = c(29),
            e = c(11),
            f = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/,
    ...
    function (a, b, c) {
        function f(a, b) {
            if ("function" != typeof a || (null != b && "function" != typeof b)) throw new TypeError(e);
            var c = function () {
                var d = arguments,
    ...
    function (a, b, c) {
        function j(a, b, c) {
            ...
            return l || ++j != k ? l : ((k = null == a ? 0 : a.length), !!k && h(k) && g(m, k) && (f(a) || e(a)));
        }
        var d = c(113),
            e = c(27),
            f = c(29),
    ...
    function (a, b, c) {
        function j(a, b, c, j) {
            ...
            var k = a.length;
            return c < 0 && (c = i(k + c, 0)), f(a) ? c <= k && a.indexOf(b, c) > -1 : !!k && d(a, b, c) > -1;
        }
        var d = c(133),
            e = c(43),
            f = c(136),
    ...
    function (a, b, c) {
        ...
        function m(a, b) {
            ...
            if (!(0, i.default)(a.init)) return console.warn("%s is missing an init method", c), b;
            var c = (0, g.default)(a, "info.name", a);
            if (void 0 !== b._plugins) {
                if (b._plugins.indexOf(c) > -1) return console.warn("%s has already been loaded for %o", c, b), b;
                b._plugins.push(c);
            } else b._plugins = [c];
            return a.init(b), b;
        }
        Object.defineProperty(b, "__esModule", { value: !0 }), (b.usePlugin = m);
        var d = c(29),
            e = l(d),
            f = c(111),
            g = l(f),
    ...
    function (a, b, c) {
        ...
        var d =
            ...
            ba = ["keyup", "keydown", "mousedown", "input", "focus", "blur", "drop", "paste"],
            ca = "fk-active",
            da = (function (a) {
                function b(a, e) {
                    var f,
                    ...
                    Y(this, b);
                    var j = Z(this, (b.__proto__ || Object.getPrototypeOf(b)).call(this));
                    (j.el = a), (j.document = e), (j.config = d({}, R.default, h));
                    var l = j;
                    (j.commands = new x.default(j)), (j.behaviors = new B.default(j)), (j.selection = new z.default(j)), (j.properties = new H.default(j.config.properties, j.config.rules));
                    var m = ["/selection-marker", "fk-ui.*", "fk-iframe-wrapper/"];
                    (j.normalizations = (0, s.default)(j)),
                        (j.context = { element: j.el, previousSibling: j.el, closestElementWithRules: j.el, ancestorElement: j.el, properties: {}, isMobile: (0, T.default)() }),
                        h && h.plugins && h.plugins.forEach(j.use.bind(j)),
                        j.registerNormalizations(j.normalizations, m.concat(j.config.ignoredClasses)),
                    ...
                    var n = 500,
                        o = function (b) {
                            if (!b || "link" !== b) {
                                ...
                                this.history.checkpoint(c), this.emit("history.checkpoint", this.history), this.selection.restoreSelection();
                            }
                        };
                    j.on("focus", function () {
                    ...
                    return (
                        ...
                        (0, i.default)(function () {
                            j.emit("init"), aa("Created new Editor instance", j);
                        }),
                        (f = j),
                        Z(j, f)
                    );
                    ...
                    e(b, [
                        {
                            ...
                            value: function () {
                                (0, J.default)(this.el),
                                    ...
                                    this.config.placeholder && this.el.setAttribute("placeholder", this.config.placeholder),
                        ...
                        },
                        {
                            ...
                            value: function () {
                                var b = window.navigator.userAgent;
                                if (b.match(/iPad/i) || b.match(/iPhone/i)) return this.el.focus();
                        ...
                        },
                        {
                            ...
                            value: function (b, c, d) {
                                this.normalizations[b].add(c, d, { at: "start" });
                            },
                        },
                        {
                            key: "registerNormalizations",
                            value: function (b, c) {
                                var d = (0, r.getNormalizationCallbacks)(this.normalizations, this),
                                    e = new RegExp(c.join("|"));
                                this.mutationObserver = new q.default(this.el, d, e);
                            },
                        },
                        {
                            key: "setHTML",
                            value: function (b) {
                                this.history.reset(), (this.el.innerHTML = b), (0, J.default)(this.el), this.selection.update();
                            },
                        },
                        {
                            key: "getHTML",
                        ...
                        },
                        {
                            ...
                            value: function (b) {
                                b &&
                                    ((b === this.context.element && b.previousSibling === this.context.previousSibling) ||
                                        ((0, t.restoreSelectionColor)(),
                                        b != this.el &&
                                            this.el.contains(b) &&
                                            ((this.context.element = b),
                                            (this.context.previousSibling = b.previousSibling),
                                            (this.context.closestElementWithRules = this.dom.getClosestElementWithRules(b)),
                                            (this.context.ancestorElement = this.dom.getAncestorElement(b)),
                                            (this.context.properties = this.properties.forElement(this.context.closestElementWithRules).all()),
                                            this.updateActiveClassName(this.context),
                                            this.emit("contextChange", b)),
                                        this.context.properties.hidesCursor && (this.selection.selectNode(this.context.closestElementWithRules), (0, t.hideSelectionColor)())));
                            },
                        },
                        {
                            key: "isActive",
                        ...
                        },
                        {
                            ...
                            value: function (b) {
                                for (var c = this.el.querySelectorAll("." + ca), d = 0; d < c.length; d++) c[d].classList.remove(ca), c[d].classList.length || c[d].removeAttribute("class");
                                b.closestElementWithRules && (b.closestElementWithRules.classList.add(ca), b.ancestorElement.classList.add(ca));
                            },
                        },
                        {
                            key: "onKeyup",
                            value: function (b) {
                                if (b.target === this.el) {
                                    ...
                                    (0, L.default)(this.selection.range, c) && this.updateContext(c);
                                }
                            },
                        },
                        {
                            ...
                            value: function (b) {
                                var c = this;
                                if (b.defaultPrevented || this.commands.executeKeyboardShortcut(b)) return b.preventDefault();
                                if ((8 === b.keyCode || 46 === b.keyCode) && this.context.closestElementWithRules.hasAttribute("fk-placeholder")) return b.preventDefault();
                                {
                                    if (!(0, L.default)(this.selection.range, this.context.closestElementWithRules) || this.selection.range.commonAncestorContainer === this.el)
                                        return F.default.affectsContent(b) && this.el === b.target
                                            ? this.selection.fix()
                                            : void (0, i.default)(function (a) {
                                                  if (F.default.affectsContent(b)) {
                                                      c.selection.update();
                                                      var d = c.selection.getCurrentElement();
                                                      d && c.updateContext(d);
                                                  }
                                              });
                                    var d = F.default.getKeyByCode(b.keyCode),
                                        e = this.context.properties["on" + (0, m.default)(d)],
                                        f = this.context.properties.onKeydown,
                                        g = this.context.element;
                                    if (("function" == typeof f && f.apply(this, [b, g, this]), "function" == typeof e)) e.apply(this, [b, g, this]);
                                    else if (e) return this.behaviors.trigger(e, b, this.context.closestElementWithRules);
                                }
                            },
                        },
                        {
                            ...
                            value: function () {
                                ...
                                (0, i.default)(function () {
                                    ...
                                    if (!b.el.innerHTML.length || (a && !a.textContent.length && !a.nextElementSibling && !b.el.textContent.length)) {
                                        for (; b.el.firstElementChild; ) b.el.removeChild(b.el.firstElementChild);
                                        var c = document.createElement("p");
                                        return (
                                            c.setAttribute("fk-placeholder", _[Math.floor(Math.random() * _.length)]),
                                            b.el.appendChild(c),
                                            b.selection.placeCaret(b.el.firstElementChild, { at: "start" }),
                                            b.updateContext(b.el.firstElementChild)
                                        );
                                    }
                                    b.el.firstElementChild.nextElementSibling && b.el.firstElementChild.nextElementSibling.removeAttribute("fk-placeholder"), b.el.firstElementChild.removeAttribute("fk-placeholder");
                                }),
                        ...
                        },
                        {
                            key: "onBlur",
                            value: function (b) {
                                this.document.setActiveEditor(null), (0, t.restoreSelectionColor)();
                            },
                        },
                        {
                            key: "onMousedown",
                            value: function (b) {
                                ...
                                b.target === this.el &&
                                    ...
                                    this.focus(),
                                    this.el.contains(b.target) && this.updateContext(b.target);
                            },
                        },
                        {
                            key: "onDrop",
                            value: function (b) {
                                ...
                                d || b.preventDefault(),
                                    (0, i.default)(function () {
                                        ...
                                        c.updateContext(a), c.dom.insertAfter(a, c.context.ancestorElement);
                                    });
                            },
                        },
                        {
        ...
        (da.prototype.setContent = da.prototype.setHTML), (da.prototype.getContent = da.prototype.getHTML), (b.default = da);
    },
    function (a, b, c) {
        var d = c(142),
            e = c(143),
    ...
    function (a, b) {
        ...
        (d.prototype._events = void 0),
            (d.prototype.listeners = function (b) {
                ...
                for (var c = 0, d = this._events[b].length, e = new Array(d); c < d; c++) e[c] = this._events[b][c].fn;
                return e;
            }),
            (d.prototype.emit = function (b, c, d, e, f, g) {
                ...
                if ("function" == typeof h.fn) {
                    ...
                    for (k = 1, j = new Array(i - 1); k < i; k++) j[k - 1] = arguments[k];
                    h.fn.apply(h.context, j);
                } else {
                    var m,
                        l = h.length;
                    for (k = 0; k < l; k++)
                        switch ((h[k].once && this.removeListener(b, h[k].fn, !0), i)) {
                            case 1:
                            ...
                            case 3:
                                ...
                                break;
                            default:
                                if (!j) for (m = 1, j = new Array(i - 1); m < i; m++) j[m - 1] = arguments[m];
            ...
            (d.prototype.on = function (b, d, e) {
                ...
                return this._events || (this._events = {}), this._events[b] ? (this._events[b].fn ? (this._events[b] = [this._events[b], f]) : this._events[b].push(f)) : (this._events[b] = f), this;
            }),
            ...
            (d.prototype.removeListener = function (b, c, d) {
                ...
                var e = this._events[b],
                    f = [];
                if (c && (e.fn && (e.fn !== c || (d && !e.once)) && f.push(e), !e.fn)) for (var g = 0, h = e.length; g < h; g++) (e[g].fn !== c || (d && !e[g].once)) && f.push(e[g]);
                return f.length ? (this._events[b] = 1 === f.length ? f[0] : f) : delete this._events[b], this;
            }),
            (d.prototype.removeAllListeners = function (b) {
                return this._events ? (b ? delete this._events[b] : (this._events = {}), this) : this;
            }),
    ...
    function (a, b, c) {
        ...
        var d = (function () {
            ...
            n = (function () {
                function a(b, c) {
                    var d = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : /skipped\-class/;
                    l(this, a), (this.el = b), (this.skippedClasses = d), (this.callbacks = c), (this.observer = this.createObserver(this.handleMutations.bind(this))), this.connect();
                }
                return (
                    d(a, [
                        {
                        ...
                        },
                        {
                            key: "shouldSkipNode",
                            value: function (b) {
                                return b.nodeType !== Node.ELEMENT_NODE || this.skippedClasses.test(b.getAttribute("class"));
                            },
                        },
                        {
                            key: "handleMutations",
                            value: function (b) {
                                ...
                                this.paused ||
                                    ((this.paused = !0),
                                    (this.seen = []),
                                    (0, f.default)(b, this.handleMutationRecord.bind(this)),
                                    (this.seen = []),
                        ...
                        },
                        {
                            ...
                            value: function (b) {
                                ...
                                (0, f.default)(b.addedNodes, function (a) {
                                    ...
                                    (0, f.default)(b.removedNodes, function (a) {
                                        c.processNode(a, "removedNodes");
                                    }),
                                    this.seen.indexOf(b.target) === -1 && this.processNode(b.target, "modifiedNodes");
                            },
                        },
                        {
                            key: "processNode",
                        ...
                        },
                        {
                            ...
                            value: function () {
                                ...
                                (this.paused = !0),
                                    (this.seen = []),
                                    (0, f.default)(this.el.childNodes, function (a) {
                        ...
                        },
                        {
                            key: "connect",
                            value: function () {
                                return this.observer.observe(this.el, { childList: !0, subtree: !0, attributes: !0 });
                            },
                        },
                        {
                            key: "disconnect",
    ...
    function (a, b, c) {
        (function (d) {
            ...
            (b = a.exports = c(163)),
                ...
                (b.load = i),
                (b.useColors = e),
                (b.storage = "undefined" != typeof chrome && "undefined" != typeof chrome.storage ? chrome.storage.local : j()),
    ...
    function (a, b) {
        ...
        function h(a) {
            ...
            if ((d === f || !d) && setTimeout) return (d = setTimeout), setTimeout(a, 0);
            try {
                return d(a, 0);
            } catch (b) {
                try {
        ...
        function i(a) {
            ...
            if ((e === g || !e) && clearTimeout) return (e = clearTimeout), clearTimeout(a);
            try {
                return e(a);
            } catch (b) {
                try {
        ...
        function n() {
            k && l && ((k = !1), l.length ? (j = l.concat(j)) : (m = -1), j.length && o());
        }
        function o() {
            if (!k) {
                var a = h(n);
    ...
    function (a, b, c) {
        ...
        function g(a) {
            ...
            function d() {
                var a = d,
                    c = +new Date(),
                    g = c - (e || c);
                (a.diff = g), (a.prev = e), (a.curr = c), (e = c), null == a.useColors && (a.useColors = b.useColors()), null == a.color && a.useColors && (a.color = f());
                for (var h = new Array(arguments.length), i = 0; i < h.length; i++) h[i] = arguments[i];
                (h[0] = b.coerce(h[0])), "string" != typeof h[0] && (h = ["%o"].concat(h));
                var j = 0;
        ...
        function h(a) {
            ...
            for (var c = (a || "").split(/[\s,]+/), d = c.length, e = 0; e < d; e++)
                c[e] && ((a = c[e].replace(/[\\^$+?.()|[\]{}]/g, "\\$&").replace(/\*/g, ".*?")), "-" === a[0] ? b.skips.push(new RegExp("^" + a.substr(1) + "$")) : b.names.push(new RegExp("^" + a + "$")));
        }
        function i() {
            b.enable("");
        }
        ...
        (b = a.exports = g.debug = g), (b.coerce = k), (b.disable = i), (b.enable = h), (b.enabled = j), (b.humanize = c(164)), (b.names = []), (b.skips = []), (b.formatters = {});
        var e,
            d = 0;
    },
    function (a, b) {
        ...
        function i(a) {
            return a >= f ? Math.round(a / f) + "d" : a >= e ? Math.round(a / e) + "h" : a >= d ? Math.round(a / d) + "m" : a >= c ? Math.round(a / c) + "s" : a + "ms";
        }
        function j(a) {
            return k(a, f, "day") || k(a, e, "hour") || k(a, d, "minute") || k(a, c, "second") || a + " ms";
        }
        function k(a, b, c) {
    ...
    function (a, b, c) {
        ...
        function q(a) {
            if ("DIV" === a.tagName && !a.textContent.trim().length && !a.classList.length) {
                var b = document.createElement("p");
                return (b.innerHTML = "<br>"), b;
            }
        }
        function r(a) {
            if (a.parentNode && a.hasAttribute("style") && "SPAN" === a.tagName) return !1;
        }
        function s(a) {
            if (a.parentNode && a.hasAttribute("style") && "SPAN" === a.tagName) return !1;
        }
        function s(a) {
            if (a.matches("ul,ol")) {
                var b = a.nextElementSibling,
                    c = b && b.nextElementSibling && b.nextElementSibling.matches("ul,ol") ? b.nextElementSibling : a;
                [].slice.call(c.children).forEach(function (a) {
                    null === a.className.match(/l[0-9]/g) ? 0 : a.className.match(/l[0-9]/g).length;
                    if (a.matches(":first-child")) return a.classList.remove("l0", "l1");
                });
            }
        }
        function t(a) {
        ...
        function u(a) {
            return function (c) {
                [].forEach.call(c.childNodes, function (b) {
                    if (b.parentNode === a && b.nodeType === Node.TEXT_NODE && "" !== b.nodeValue.trim()) {
                        var c = document.createElement("p");
                        return (c.innerHTML = b.nodeValue), b.parentElement.replaceChild(c, b), c;
                    }
                });
            };
        }
        function v(a) {
            return function (c) {
                ...
                if (d instanceof HTMLElement) (0, j.default)(d, a);
                    ...
                    for (var e = document.createElement("p"); c.firstChild; ) e.appendChild(c.firstChild);
                    return (0, j.default)(e, a), (0, l.default)("Normalizations:applyCSSRuleSet")("Unwrapping unregistered %o tag and rewrap with a `P` node", c), c.parentNode.replaceChild(e, c), e;
                }
            };
        }
        function w(a) {
            return function (c) {
                ...
                if (d && c.parentNode) {
                    ...
                    if (!e) {
                        ...
                        (f.innerHTML = c.textContent || "<br>"), (f.innerHTML += n), c.parentNode.replaceChild(f, c);
                    }
                }
            };
        }
                    ...
                    d.forEach(
                        function (a) {
                            if (!c.closest(a)) {
                                ...
                                return c.parentNode.insertBefore(b, c), b.appendChild(c), void l.default.log("Normalizations:ensureNeededParent")("Wrapping %o node with cloned %o node", c, b);
                            }
                        }.bind(this)
                    );
            };
        ...
        function y(a) {
            if ("IFRAME" === a.tagName) {
                ...
                return (b.className = "fk-iframe-wrapper"), a.parentNode.insertBefore(b, a), void b.appendChild(a);
            }
        }
        function z(a) {
            var b = a.config.inline ? n + "<br/>" : "<p>" + n + "<br/></p>",
                c = { addedNodes: g.default.create(), removedNodes: g.default.create(), modifiedNodes: g.default.create(), loadDocument: g.default.create(), exportDocument: g.default.create() };
            return (
                c.addedNodes
                    .add("wrapIframes", y)
                ...
                c.modifiedNodes.add("ensureLastEditableElement", o(a.el, b)).add("ensureNeededChildren", w(a.properties)).add("ensureNeededParent", x(a.properties)),
                c.loadDocument.add("wrapIframes", y),
                a.config.inline ? c.modifiedNodes.add("applyCSSRuleSet", v(a.properties)) : (c.addedNodes.add("ensureParagraphWrapper", q), c.modifiedNodes.add("ensureWrappedTextNodes", u(a.el))),
                c
            );
        }
        function A(a, b) {
                ...
                for (var e = void 0, f = d, g = 0; g < a.length; g++) {
                    ...
                    if (void 0 !== e) {
                        ...
                        "string" == typeof e || "number" == typeof e
                            ? ((e = document.createTextNode(e)), i.replaceChild(e, f), (f = e))
                            : 1 == e.nodeType && i
                            ? (i.replaceChild(e, f), (f = e))
                            : 11 == e.nodeType && ((child = e.firstChild), i.replaceChild(e, f), (f = child));
                    }
                }
        ...
        function C(a) {
            for (var b = document.createDocumentFragment(); a.childNodes.length; ) b.appendChild(a.firstChild);
            return b;
        }
        Object.defineProperty(b, "__esModule", { value: !0 }),
        ...
        var c = (function () {
            ...
            e = (function () {
                function a() {
                    ...
                    d(this, a), (this.functions = []), (this.functionNames = []);
                }
                return (
                    c(
                        a,
                        [
                            {
                                key: "add",
                                value: function (b, c) {
                                    var d = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : { at: "end" };
                                    if (this.functionNames.indexOf(b) !== -1) return console.warn("%s function already exists in the set", b), this;
                                    var e = d.after || d.before;
                                    if (e) {
                                        var f = this.functionNames.indexOf(e);
                                        if (f !== -1) return d.after && (f += 1), this.functions.splice(f, 0, c), this.functionNames.splice(f, 0, b), this;
                                    }
                                    return "start" === d.at ? (this.functions.unshift(c), this.functionNames.unshift(b), this) : (this.functions.push(c), this.functionNames.push(b), this);
                                },
                            },
                            {
                                key: "remove",
                                value: function (b) {
                                    ...
                                    return c === -1 ? (console.warn("%s does not exist in this set"), this) : (this.functions.splice(c, 1), this.functionNames.splice(c, 1), this);
                                },
                            },
                        ],
                        [
    ...
    function (a, b, c) {
        ...
        function l(a) {
            return a.parentNode && !a.parentNode.hasAttribute("contenteditable") ? l(a.parentNode) : a;
        }
        Object.defineProperty(b, "__esModule", { value: !0 }), (b.getClosestElementWithRules = k), (b.getAncestorElement = l);
        var d = c(170),
            e = c(171),
            g = (c(172), c(173)),
            h = [];
        ...
        (j.prototype.get = function (a) {
            ...
            (j.prototype.changeTag = function (a, b) {
                ...
                return (c.attributes = a.attributes), (c.innerHTML = a.innerHTML), this.replaceElement(a, c), c;
            }),
            (j.prototype.insertBefore = function (a, b) {
                return b.parentNode.insertBefore(a, b);
            }),
            (j.prototype.insertAfter = function (a, b) {
                return b.nextSibling ? b.parentNode.insertBefore(a, b.nextSibling) : void b.parentNode.appendChild(a);
            }),
            ...
            (j.prototype.getAncestorElement = function (a, b) {
                return a.parentNode && a.parentNode !== this.editor.el ? this.getAncestorElement(a.parentNode) : a;
            }),
            ...
            (j.prototype.hidesCursor = function (a) {
                return this.editor.properties.forElement(a).property("hidesCursor");
            }),
            ...
            (j.prototype.getNearestCursorTarget = function (a) {
                if ("BR" !== a.tagName) {
                    var b = this.get("h1,h2,h3,h4,h5,h6,p,dt,dd,li,address,blockquote,div,fieldset,hr,th,td"),
                        c = b.indexOf(a),
                        d = function (a) {
                            return this.editor.properties.forElement(a).property("isFocusable");
                        }.bind(this);
                    return { before: b.slice(0, c).filter(d), after: b.slice(c + 1).filter(d) };
                }
            }),
            (b.default = j);
    },
    ...
    function (a, b) {
        a.exports = { area: !0, base: !0, br: !0, col: !0, embed: !0, hr: !0, img: !0, input: !0, keygen: !0, link: !0, menuitem: !0, meta: !0, param: !0, source: !0, track: !0, wbr: !0 };
    },
    function (a, b, c) {
        "use strict";
        function h(a) {
        ...
        function j(a, b) {
            if (!a.getAttribute("contentEditable")) {
                ...
                for (var d = 0; d < c.length; d++) {
                    ...
                    b.indexOf(e) !== -1 || f || (i("Removing forbidden %o attribute", e), a.removeAttribute(e));
                }
            }
        }
        function k(a, b) {
            ...
            return (
                ...
                [].forEach.call(a.children, function (a) {
                    "BR" === a.tagName || /selection\-marker/.test(a.className) || ((d.length && a.matches(d.join(","))) || a.getAttribute("contentEditable") || (i("Unwrapping forbidden %o tag", a), (a = (0, e.default)(a))), k(a, b));
                })
            );
        }
    ...
    function (a, b) {
        ...
        function c(a) {
            var b = a.parentNode;
            if (b) {
                for (var c = document.createDocumentFragment(); a.firstChild; ) c.appendChild(a.firstChild);
    ...
    function (a, b) {
        ...
        function d() {
            ...
            a.styleSheet ? (a.styleSheet.cssText = b) : a.appendChild(document.createTextNode(b)), document.body.appendChild(a);
        }
        function e() {
        ...
        Object.defineProperty(b, "__esModule", { value: !0 }), (b.hideSelectionColor = d), (b.restoreSelectionColor = e);
    ...
    function (a, b, c) {
        ...
        var d = (function () {
            ...
            j = (function () {
                function a() {
                    var b = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : a.MAX_STACK_SIZE;
                    h(this, a), (this.maxStackSize = b), this.reset(), this.enable();
                }
                return (
                    d(a, [
                        {
                            ...
                            value: function (b) {
                                this.disabled ||
                                    (0 !== this.undoStack.length && b === this.undoStack[this.undoStack.length - 1]) ||
                                    (this.undoStack.push(b), (this.redoStack = []), this.undoStack.length >= this.maxStackSize && this.undoStack.splice(0, this.undoStack.length - this.maxStackSize));
                            },
                        },
                        {
                            key: "undo",
                            value: function () {
                                return this.undoStack.length > 1 && this.redoStack.push(this.undoStack.pop()), this.log("Undo"), this.undoStack[this.undoStack.length - 1];
                            },
                        },
                        {
                            key: "redo",
                            value: function () {
                                ...
                                return this.undoStack.push(b), this.log("Redo"), b;
                            },
                        },
                        {
                            key: "canUndo",
                            value: function () {
                                return !this.disabled && this.undoStack.length > 1;
                            },
                        },
                        {
                            key: "canRedo",
    ...
    function (a, b, c) {
        ...
        (j.prototype.register = function (a, b) {
            ...
            (j.prototype.callMethod = function (a, b, c) {
                ...
                return e instanceof HTMLElement && "execute" === a && (this.editor.selection.selectNode(e), this.editor.updateContext(e)), e;
            }),
            (j.prototype.execute = function (a, b) {
                i("Execute %s with params %o", a, b), this.editor.emit("commandExecuted", a);
                ...
                if (a.metaKey || a.ctrlKey)
                    return [].some.call(
                        ...
                        function (b) {
                            ...
                            if (c && c(a)) return a.preventDefault(), this.execute(b), !0;
                        }.bind(this)
                    );
            }),
            (a.exports = j);
    ...
    function (a, b) {
        ...
        var c = {
            ...
            changesCaretPosition: function (b) {
                var c = b.keyCode;
                return this.isArrowKey(b) || c === this.backspace || c === this.enter || c === this.delete;
            },
            getKeyByCode: function (b) {
                for (var c in this) if (this.hasOwnProperty(c) && this[c] === b) return c;
            },
        };
        a.exports = c;
    },
    function (a, b, c) {
        ...
        var d = c(183),
            ...
            t = c(206),
            u = function (b) {
                (this.editor = b), this.update(), this.editor.on("selectionchange", this.update.bind(this));
            };
        (u.prototype.containsNode = e),
            ...
            (u.prototype.update = function () {
                (this.selection = document.getSelection()),
                    this.selection.rangeCount &&
                        ((this.range = !!this.selection.rangeCount && this.selection.getRangeAt(0)),
                        (this.normalizedRange = d(this.range.cloneRange())),
                        (this.startElement = 1 === this.normalizedRange.startContainer.nodeType ? this.normalizedRange.startContainer : this.normalizedRange.startContainer.parentNode),
                        (this.endElement = 1 === this.normalizedRange.endContainer.nodeType ? this.normalizedRange.endContainer : this.normalizedRange.endContainer.parentNode));
            }),
            (u.prototype.getType = function () {
                var a = d(this.range.cloneRange());
                if (!a.endContainer) return !1;
                if (a.collapsed) return "cursor";
                if (a.commonAncestorContainer === this.editor.el) return "overlap";
                var b = this.fullyContainsNode(this.range, this.editor.context.ancestorElement);
                return b ? "full" : "partial";
            }),
            (u.prototype.toggleTag = function (a) {
                return this.endElement.closest(a) || this.startElement.closest(a) ? this.unwrap(a) : void this.wrap(a);
            }),
            ...
            (u.prototype.setSingleRange = function (a) {
                this.selection.removeAllRanges(), this.selection.addRange(a), this.update(), this.editor.isActive() || this.editor.el.focus();
            }),
            ...
            (u.prototype.selectNode = function (a) {
                ...
                this.editor.dom.hidesCursor(a) ? b.selectNode(a) : b.selectNodeContents(a), this.setSingleRange(b), this.editor.focus();
            }),
            (u.prototype.getAdjacentVoidElement = function () {
                ...
                if (a.rangeCount) {
                    ...
                    for (c === this.editor.el && ((c = c.children[b.startOffset]), (d = d.children[b.endOffset - 1])); d && c.lastChild && c.lastChild.nodeType === Node.ELEMENT_NODE; ) c = c.lastChild;
                    for (; d && d.lastChild && d.lastChild.nodeType === Node.ELEMENT_NODE; ) d = d.lastChild;
                    return this.editor.dom.hidesCursor(c) ? c : !!this.editor.dom.hidesCursor(d) && d;
                }
            }),
            (a.exports = u);
    },
        ...
        function e(a) {
            ...
            if (1 === b.nodeType)
                if (d[b.nodeName]) {
                    ...
                    c >= b.childNodes.length ? ((h = !0), (b = b.childNodes[b.childNodes.length - 1])) : ((h = !1), (b = b.childNodes[c]));
                    for (var j; b && 3 !== b.nodeType && ((j = h ? b.lastChild : b.firstChild), !j || !d[j.nodeName]); ) b = j;
                    b ? (c = 1 === b.nodeType ? (h ? b.childNodes.length : 0) : h ? b.nodeValue.length : 0) : ((b = a.startContainer), (c = a.startOffset));
                }
            if (g) (e = b), (f = c);
            else
                for (;;) {
                    if (0 === f) {
                        ...
                        if (!e) {
                            g ? ((e = b), (f = c)) : ((e = a.endContainer), (f = a.endOffset));
                            break;
                        }
                        (e = e.previousSibling), (f = 3 === e.nodeType ? e.nodeValue.length : e.childNodes.length);
                    }
                    if (3 === e.nodeType && /^\n+$/.test(e.textContent)) {
                        for (; e && !e.previousSibling; ) e = e.parentNode;
                        e && ((e = e.previousSibling), (f = 3 === e.nodeType ? e.nodeValue.length : e.childNodes.length));
                    }
                    if (1 === e.nodeType) {
                        if (d[e.nodeName]) {
                            var i = e;
                            (e = i.parentNode), (f = indexOf(e.childNodes, i) + 1);
                            break;
                        }
                        (h = !0), (e = f >= e.childNodes.length ? e.childNodes[e.childNodes.length - 1] : e.childNodes[f - 1]);
                        for (var j; e && 3 !== e.nodeType && ((j = e.lastChild), !j || !d[j.nodeName]); ) e = j;
                        if (e) {
                            f = 1 === e.nodeType ? e.childNodes.length : e.nodeValue.length;
                            break;
                        }
                        g ? ((e = b), (f = c)) : ((e = a.endContainer), (f = a.endOffset));
                        break;
            ...
            return (b === a.startContainer && c === a.startOffset) || a.setStart(b, c), (e === a.endContainer && f === a.endOffset) || a.setEnd(e, f), a;
        }
        var d = c(175);
    ...
    function (a, b) {
        ...
        function c(a, b) {
            ...
            return c.selectNodeContents(a), b.compareBoundaryPoints(b.END_TO_START, c) <= 0 && b.compareBoundaryPoints(b.START_TO_END, c) >= 0;
        }
        a.exports = c;
    },
    function (a, b) {
    ...
    function (a, b) {
        ...
        function c(a, b, c) {
            ...
            if (c || d.rangeCount > 0) {
                ...
                e.selectNodeContents(a), e.setStart(c.endContainer, c.endOffset);
    ...
    function (a, b, c) {
        ...
        function f(a, b) {
            ...
            var c = d(b),
                ...
                h = b.lastChild;
            do "BR" === h.tagName && (g = h.previousSibling), (h = "BR" === h.tagName ? h.previousSibling : h.lastChild);
            while (h && 1 === h.nodeType);
            return f && g ? (c.setStart(f, 0), c.setEnd(g, g.length)) : c.selectNodeContents(b), a.compareBoundaryPoints(Range.START_TO_START, c) < 1 && a.compareBoundaryPoints(Range.END_TO_END, c) > -1;
        }
        var d = c(185),
            e = c(188);
        a.exports = f;
    ...
    function (a, b, c) {
        ...
        function m(a, b, c) {
            ...
            for (var f in e) {
                ...
                b &&
                    !i() &&
                    ((h(b) && ["BR", "IMG", "HR", "IFRAME", "TEXTAREA", "INPUT"].indexOf(b.tagName) < 0 && !b.classList.contains("selection-marker") && !b.classList.contains("checklist__item__box")) || g(b)) &&
    ...
    function (a, b, c) {
        ...
        function f(a) {
            ...
            if (b.rangeCount) {
                ...
                return d.selectNodeContents(a), e(d), c.compareBoundaryPoints(c.START_TO_START, d) <= 0;
            }
            return !1;
        }
        var e = (c(195), c(183));
    ...
    function (a, b, c) {
        ...
        function f(a) {
            ...
            if (b.rangeCount) {
                ...
                var f = a.lastChild;
                return f && 1 === f.nodeType && "BR" === f.tagName && ((f = f.previousSibling), f && d.setEnd(f, f.length)), c.compareBoundaryPoints(c.END_TO_END, d) >= 0;
            }
            return !1;
        }
        var e = (c(188), c(183));
    ...
    function (a, b) {
        "use strict";
        function c(a, b) {
            if (!b.parentNode || !window.getSelection().getRangeAt(0).startContainer.parentNode) return !1;
            var c = document.createRange();
            return c.selectNode(b), a.compareBoundaryPoints(a.START_TO_START, c) >= 0 && a.compareBoundaryPoints(a.END_TO_END, c) <= 0;
        }
        a.exports = c;
    },
    function (a, b) {
        ...
        a.exports = function (b) {
            var c = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : { at: "start" },
                d = window.getSelection(),
                e = document.createRange();
            e.selectNodeContents(b), e.collapse("start" === c.at), d.removeAllRanges(), d.addRange(e);
        };
    },
    function (a, b, c) {
        "use strict";
            ...
            e = {
                save: function () {
                    ...
                    if (b.rangeCount) {
                        ...
                        f.classList.add("selection-marker", "end-marker"), d(c, f, !0), c.collapsed ? c.collapse(!0) : d(c, e);
                    }
                    return c;
                },
                restore: function () {
                    ...
                    if (!c.length) return (b = window.getSelection()), !!b.rangeCount && b.getRangeAt(0);
                    var d = document.createRange();
                    d.setStartBefore(c[0]), 2 === c.length ? d.setEndAfter(c[1]) : d.setEndAfter(c[0]), this.removeMarkers();
                    var b = document.getSelection();
                    return b.removeAllRanges(), b.addRange(d), d;
                },
                removeMarkers: function () {
                    Array.prototype.forEach.call(document.querySelectorAll(".selection-marker"), function (a) {
                        var b = a.parentNode;
                        b.removeChild(a), (Object.hasOwnProperty.call(window, "ActiveXObject") && !window.ActiveXObject) || b.normalize();
                    });
                },
            };
        a.exports = e;
    ...
    function (a, b) {
        ...
        function c(a) {
            ...
            for (var c, d; a.firstChild; ) c || (c = a.firstChild), (d = a.firstChild), a.parentNode.insertBefore(a.firstChild, a);
            if ((a.parentNode.removeChild(a), c && b.selectNodeContents(c), d)) {
    ...
    function (a, b, c) {
        ...
        function r(a, b, c) {
            function o(a) {
                ...
                q("Wrapping Range %o with new %o node", a.toString(), d), d.appendChild(a.extractContents()), i(a, d);
                for (var k = d.querySelectorAll(b), l = 0; l < k.length; l++) q("Removing duplicate childNode %o", k[l]), j(k[l]);
            ...
            for (
                ...
                l && l !== r && (d.setEndAfter(l), n.push(h(d)), (d = e.cloneRange()), d.setStartBefore(r)), (l = r);
            }
            n.push(h(d));
    ...
    function (a, b, c) {
        ...
        function f(a, b, c) {
            ...
            var a = e(a.cloneRange()),
                h = (a.startContainer, a.endContainer, a.commonAncestorContainer),
                i = 1 === h.nodeType ? h : h.parentNode,
                j = function (e) {
                    return d(e, a) ? (c ? c(e) : NodeFilter.FILTER_ACCEPT) : NodeFilter.FILTER_REJECT;
                };
    ...
    function (a, b, c) {
        ...
        function t(a, b) {
            function u(a) {
                var c = 1 === a.commonAncestorContainer.nodeType ? a.commonAncestorContainer : a.commonAncestorContainer.parentNode,
                    f = c.closest(b);
                if (f) {
                    j.save();
                    var g = k(f);
                    (e = j.restore()), j.save();
                    var h = g.cloneRange();
                    h.setEnd(e.startContainer, e.startOffset), h.toString().trim() && (s("re-wrapping left-hand side with new %o node", b), i(h, b)), (e = j.restore());
                    var m = g.cloneRange();
                    m.setStart(e.endContainer, e.endOffset), m.toString().trim() && (s("re-wrapping right-hand side with new %o node", b), i(m, b)), (e = j.restore());
                } else {
                    j.save();
                    for (var q = a.startContainer.parentNode, r = a.endContainer.parentNode, t = a.extractContents(), u = t.querySelectorAll(b), v = 0; v < u.length; v++) k(u[v]);
                    if (
                        (l(a, t),
                        (e = j.restore()),
                        p(d.startContainer),
                        p(d.endContainer),
                        n(q) && q.parentNode && (s("removing start-boundary empty element node %o", q.parentNode), q.parentNode.removeChild(q)),
                        n(r) && r.parentNode && (s("removing end-boundary empty element node %o", r), r.parentNode.removeChild(r)),
                        0 === e.endOffset)
                    ) {
                        for (var w = e.endContainer; w.nodeType !== Node.TEXT_NODE; ) {
            ...
            for (
                ...
                q && q !== v && (c.setEndAfter(q), t.push(h(c)), (c = d.cloneRange()), c.setStartBefore(v)), (q = v);
            }
            t.push(h(c));
    ...
    function (a, b, c) {
        ...
        var d = (function () {
            ...
            i = (function () {
                function a(b) {
                    h(this, a), (this.editor = b), (this.__behaviorsRegistry__ = {});
                }
                return (
                    d(a, [
                        {
                        ...
                        },
                        {
                            ...
                            value: function (b, c, d) {
                                ...
                                return b.constructor === Array
                                    ...
                                    : "undefined" == typeof this.__behaviorsRegistry__[b]
                                    ? (console.warn(
                                      ...
                                      !0)
                                    : this.__behaviorsRegistry__[b].apply(this, [c, d, this.editor]);
                            },
                        },
                    ]),
                    a
        ...
        var d = (function () {
            ...
            i = (function () {
                function a() {
                    ...
                    h(this, a), (this.properties = {}), (this.rules = []), this.resetCachedProperties(), this.addProperties(b), this.addRules(c);
                }
                return (
                    d(
                        a,
                        [
                            {
                                ...
                                value: function () {
                                    (this.inheritedProperties = []), (this.propertiesWithDefaultValue = []);
                                },
                            },
                            {
                                key: "addProperties",
                                value: function (b) {
                                    ...
                                    this.resetCachedProperties(),
                                        Object.keys(b).forEach(function (a) {
                                            var d = b[a];
                                            (c.properties[a] = d), d.defaultValue && c.propertiesWithDefaultValue.push(a), d.inherited && c.inheritedProperties.push(a);
                                        });
                                },
                            },
                            {
                                ...
                                value: function (c) {
                                    ...
                                    Object.keys(c).forEach(function (b) {
                                        c[b].constructor === Object ? d.addRules(c[b], a.prependParentSelector(b, e)) : (f[b] = c[b]);
                                    }),
                            ...
                            },
                            {
                                ...
                                value: function (c, d) {
                                    ...
                                    c.split(",").forEach(function (b) {
                                        ...
                                        c && e.rules.push({ selector: b, specificity: c, properties: d });
                                    });
                                },
                            },
                            {
                                ...
                                value: function (b) {
                                    var c = this;
                                    if (!b instanceof HTMLElement) return console.warn("The element should be an instance of HTMLElement");
                                    var d = function (d) {
                                ...
                                value: function (b, c) {
                                    ...
                                    if (
                                        (this.rules.forEach(function (a) {
                                            if (b.matches(a.selector) && "undefined" != typeof a.properties[c]) {
                                                var e = a.properties[c],
                                                    f = a.specificity;
                                                f >= d.specificity && (d = { specificity: f, value: e });
                                            }
                                        }),
                                        null === d.value)
                                    ) {
                                        var e = this.properties[c] || {};
                                        if (e.inherited && b.parentElement) return this.getPropertyValue(b.parentElement, c);
                                        if ("undefined" != typeof e.defaultValue) return e.defaultValue;
                                    }
                                    return d.value;
                                },
                            },
                                    ...
                                    return (
                                        this.rules.forEach(function (a) {
                                            b.matches(a.selector) &&
                                                !(function () {
                                                    var b = a.specificity;
                                                    Object.keys(a.properties).forEach(function (c) {
                                                        (!g[c] || g[c] <= b) && ((g[c] = b), (f[c] = a.properties[c]));
                                                    });
                                                })();
                                        }),
                                        d &&
                                            this.inheritedProperties.forEach(function (a) {
                                                "undefined" == typeof f[a] && b.parentElement && (f[a] = c.getPropertyValue(b.parentElement, a));
                                            }),
                                        e &&
                                            this.propertiesWithDefaultValue.forEach(function (a) {
                                                "undefined" == typeof f[a] && (f[a] = c.properties[a].defaultValue);
                                            }),
                                        f
                                    );
                                },
                        ...
                        [
                            ...
                            },
                            {
                                ...
                                value: function (b) {
                                    return parseInt((0, f.default)(b).join(""), 10);
                                },
                            },
                        ]
                    ),
        ...
        function l(a) {
            ...
            if ("string" == typeof a) {
                var k = 0,
                    l = 0,
                    m = 0;
                return (a = a.replace(i, " $1 ").replace(j, " ")), (k += b(d)), (l += b(c)), (l += b(e)), (m += b(f)), (l += b(g)), (m += b(h)), [0, k, l, m];
            }
        }
        var c = /(\[[^\]]+\])/g,
            d = /(#[^\s\.\[\]:]+)/g,
    ...
    function (a, b) {
        ...
        function c(a) {
            for (var b = 0; b < a.childNodes.length; b++) {
                ...
                8 === d.nodeType || (3 === d.nodeType && !/\S/.test(d.nodeValue))
                    ? (a.removeChild(d), b--)
                    : 1 === d.nodeType
                    ? c(d)
                    : 3 === d.nodeType && /(^\s+|\s+$)/.test(d.parentNode.innerHTML) && (d.parentNode.innerHTML = d.parentNode.innerHTML.replace(/(^\s+|\s+$)/g, ""));
            }
        }
        a.exports = c;
    },
    ...
    function (a, b, c) {
        ...
        var d = c(215),
            ...
            i = j(h),
            k = [];
        b.default = { properties: e.default, rules: g.default, shortcuts: i.default, ignoredClasses: k };
    },
    function (a, b) {
        "use strict";
        Object.defineProperty(b, "__esModule", { value: !0 });
        var c = {
            ...
            allowedTags: { defaultValue: ["a", "em", "strong", "img", "s"], inherited: !0 },
            allowedAttributes: { defaultValue: ["alt", "disabled", "href", "src", "title", "left", "center", "right"], inherited: !0 },
            allowedCommands: { defaultValue: ["formatBold", "formatItalic", "addLink"] },
        };
        b.default = c;
    },
    function (a, b) {
        ...
        Object.defineProperty(b, "__esModule", { value: !0 });
        var c = {
            "h1,h2,h3,h4,h5,h6,p,blockquote": { blockElement: !0, allowedCommands: ["formatH1", "formatH2", "formatBlockquote"], onBackspace: ["detectVoidElement"], onSpace: ["markdownShortcuts"], onDelete: ["normalizeDeleteKey"] },
            "h1,h2,blockquote": { allowedCommands: ["formatH1", "formatH2", "formatBlockquote", "formatParagraph", "addLink"] },
            blockquote: { allowedCommands: ["formatH1", "formatH2", "formatBlockquote", "formatParagraph", "formatItalic", "formatBold"], onEnter: ["addParagraphAfterAncestor"], p: { onEnter: ["addParagraphAfterAncestor"] } },
            "h1,h2": { allowedTags: ["a"] },
            "ul.checklist": {
                ...
                ".checklist__item": { isFocusable: !1, allowedCommands: [], allowedTags: ["div", "span"] },
                ".checklist__item__box": { isFocusable: !1, allowedCommands: [], allowedAttributes: ["class", "contenteditable", "contentEditable"] },
            },
            p: {
                allowedAttributes: ["fk-placeholder"],
                allowedTags: ["strong", "em", "b", "i", "q", "a", "s"],
                allowedCommands: ["formatH1", "formatH2", "addLink", "formatBold", "formatItalic", "formatStrikethrough", "formatBlockquote", "formatInlineQuote"],
            },
            hr: {},
            ...
            "ul, ol": {
                ...
                allowedCommands: ["formatOl", "formatUl", "formatChecklist"],
                allowedTags: ["li"],
                li: { allowedCommands: ["addLink", "formatBold", "formatItalic", "formatStrikethrough"], allowedTags: ["em", "strong", "a", "s"], allowedAttributes: ["class"], onEnter: ["outdentEmptyListItem"], onTab: ["indent"] },
    ...
    function (a, b) {
        "use strict";
        Object.defineProperty(b, "__esModule", { value: !0 }),
            (b.default = { "mod+a": "selectAll", "mod+b": "formatStrong", "mod+.": "toggleCheckbox", "mod+i": "emphasize", "mod+k": "link", "mod+u": "underline", tab: "indent", "shift+tab": "outdent", esc: "escape" });
    },
    function (a, b) {
        "use strict";
        function c() {
        ...
        a.exports = {
            formatBlock: {
                execute: function (b) {
                    ...
                    return d(e, c.innerHTML.length ? c.innerHTML : c.innerHTML + "<br/>", this.properties), this.dom.replaceElement(c, e), e;
                },
                queryState: function (b) {
                    return this.context.closestElementWithRules.toLowerCase() === b.toLowerCase();
                },
            },
        };
    },
    function (a, b, c) {
        ...
        function g(a, b, c) {
            (a.innerHTML = "string" == typeof b ? b : b.innerHTML), (0, e.default)(a, c);
        }
        var d = c(176),
            e = f(d);
        a.exports = g;
        ...
        a.exports = {
            insertOrderedList: {
                execute: function () {
                    ...
                    return (c.innerHTML = "<br>"), b.appendChild(c), this.dom.replaceElement(this.context.closestElementWithRules, b), c;
                },
            },
            insertUnorderedList: {
                execute: function () {
            ...
            insertChecklist: {
                execute: function () {
                    ...
                    var c = document.createRange().createContextualFragment('<li class="checklist__item"><span contenteditable="false" class="checklist__item__box"></span><div class="checklist__item__text"><br></div></li>'),
                        d = c.querySelector(".checklist__item__text");
                    return b.appendChild(c), this.dom.replaceElement(this.context.closestElementWithRules, b), d;
                },
            },
            insertHr: {
                execute: function () {
                    ...
                    return (c.innerHTML = "<br>"), this.dom.replaceElement(this.context.closestElementWithRules, b), this.dom.insertAfter(c, b), c;
                },
            },
            formatOrderedList: {
                execute: function () {
                    var b = document.createElement("ol");
                    return (
                        [].slice.call(this.context.ancestorElement.children).forEach(function (a) {
                            var c = document.createElement("li");
                            a.hasAttribute("class") && (c.classList.toggle("l0", a.classList.contains("l0")), c.classList.toggle("l1", a.classList.contains("l1")));
                            var d = a.querySelector(".checklist__item__text");
                            (c.innerHTML = d ? d.innerHTML : a.innerHTML), b.appendChild(c);
                        }),
                        this.dom.replaceElement(this.context.ancestorElement, b),
                        b
                    );
                },
                queryState: function () {
                    var b = this.context.ancestorElement;
                    return "OL" === b.tagName && !b.classList.contains("checklist");
                },
            },
            formatUnorderedList: {
                execute: function () {
                ...
                queryState: function () {
                    var b = this.context.ancestorElement;
                    return "UL" === b.tagName && !b.classList.contains("checklist");
                },
            },
            moveUp: {
                shortcut: function (b) {
                    return b.altKey && (b.metaKey || b.ctrlKey) && 38 === b.keyCode;
                },
                execute: function () {
                    ...
                    this.context.ancestorElement.matches("ul,ol,.checklist") &&
                        ...
                        (this.selection.saveSelection(),
                        b.previousElementSibling.classList.contains("l0") || b.classList.remove("l0"),
                        b.previousElementSibling.classList.contains("l1") || b.classList.remove("l1"),
            ...
            moveDown: {
                shortcut: function (b) {
                    return b.altKey && (b.metaKey || b.ctrlKey) && 40 === b.keyCode;
                },
                execute: function () {
                    var b = this.context.closestElementWithRules.closest("li");
                    this.context.ancestorElement.matches("ul,ol,.checklist") && b.nextElementSibling && (this.selection.saveSelection(), this.dom.insertAfter(b, b.nextElementSibling), this.selection.restoreSelection());
                },
                queryState: function () {},
            },
        };
    ...
    function (a, b) {
        ...
        a.exports = {
            italic: {
                ...
                queryState: function () {
                    if (this.selection.range) return this.selection.endElement.closest("em,i") || this.selection.startElement.closest("em,i");
                },
            },
            bold: {
                execute: function () {
                    this.selection.unwrap("b"), this.selection.toggleTag("strong"), this.emit("contentChange");
                },
                queryState: function () {
                    if (this.selection.range) return this.selection.endElement.closest("strong,b") || this.selection.startElement.closest("strong,b");
                },
            },
            strikethrough: {
                shortcut: function (b) {
                ...
                queryState: function () {
                    if (this.selection.range) return this.selection.endElement.closest("s") || this.selection.startElement.closest("s");
                },
            },
        };
    },
    function (a, b) {
        ...
        a.exports = {
            ...
            link: {
                execute: function (b) {
                    var c = b ? { href: b, class: "" } : { class: "fk-selected-link" };
                    return this.selection.wrap("a", c);
                },
                queryState: function () {
                    if (this.selection.range) {
                        var b = this.selection.endElement.closest("a") || this.selection.startElement.closest("a");
                        if (b) return b.href;
                    }
                    return !1;
                },
    ...
    function (a, b, c) {
        ...
        a.exports = {
            alignMediaLeft: {
                execute: function () {
                    var b = this.context.ancestorElement;
                    return b.classList.remove("aligncenter"), b.classList.remove("alignright"), b.classList.toggle("alignleft"), this.context.closestElementWithRules;
                },
                queryState: function () {
                    return this.context.closestElementWithRules.classList.contains("alignleft") || this.context.ancestorElement.classList.contains("alignleft");
                },
            },
            alignMediaRight: {
                execute: function () {
                    var b = this.context.ancestorElement;
                    return b.classList.remove("aligncenter"), b.classList.remove("alignleft"), b.classList.toggle("alignright"), this.context.closestElementWithRules;
                },
                queryState: function () {
                    return this.context.closestElementWithRules.classList.contains("alignright") || this.context.ancestorElement.classList.contains("alignright");
                },
            },
            alignMediaCenter: {
                execute: function (b) {
                    var c = this.context.ancestorElement;
                    return c.classList.remove("alignright"), c.classList.remove("alignleft"), c.classList.toggle("aligncenter"), this.context.closestElementWithRules;
                },
                queryState: function () {
                    return this.context.closestElementWithRules.classList.contains("aligncenter") || this.context.ancestorElement.classList.contains("aligncenter");
                },
            },
            toggleCaption: {
                execute: function (b) {
                    var c = this.context.ancestorElement.querySelector("figcaption");
                    return c
                ...
                queryState: function () {
                    return this.context.ancestorElement.querySelector("figcaption");
                },
            },
        };
    },
    function (a, b) {
        ...
        function c(a) {
            var b = a.getBoundingClientRect(),
                ...
                d = window.pageYOffset,
                e = "ontouchstart" in document.documentElement ? window.innerHeight - 0.4 * window.innerHeight : window.innerHeight,
                f = b.top + d;
            if (b.top + b.height / 2 >= e) {
                var g = f - window.innerHeight + 0.45 * window.innerHeight + b.height;
    ...
    function (a, b) {
        ...
        a.exports = {
            undo: {
                ...
                execute: function () {
                    this.history.canUndo() && (this.history.disable(), (this.el.innerHTML = this.history.undo()), this.el.focus(), this.selection.restoreSelection(), this.history.enable(), this.emit("history.undo", this.history));
                },
                queryState: function () {},
            },
            redo: {
                shortcut: function (b) {
                    var c = b.metaKey || b.ctrlKey,
                        d = String.fromCharCode(b.keyCode).toUpperCase();
                    return c && ((!b.shiftKey && "Y" === d) || (b.shiftKey && "Z" === d));
                },
                execute: function () {
                    this.history.canRedo() && (this.history.disable(), (this.el.innerHTML = this.history.redo()), this.el.focus(), this.selection.restoreSelection(), this.history.enable(), this.emit("history.redo", this.history));
                },
                queryState: function () {},
            },
        };
    ...
    function (a, b) {
        ...
        a.exports = {
            blockSave: {
                ...
                execute: function (b) {
                    document.documentElement.classList.add("author"), document.documentElement.classList.remove("focus");
    ...
    function (a, b, c) {
        ...
        function g(a, b, c) {
            if (!a.shiftKey) {
                ...
                return (g.innerHTML = d(b)), (g.innerHTML = g.innerHTML.length ? g.innerHTML : "<br>"), this.editor.dom.insertAfter(g, c.context.ancestorElement), e(g, { at: "start" }), f(g), !1;
            }
        }
        var d = c(186),
            e = c(199),
    ...
    function (a, b) {
        ...
        function c(a, b, c) {
            a.preventDefault(),
                setTimeout(function () {
                    var c = b.closest("li"),
                        d = null === c.className.match(/l[0-9]/g) ? 0 : c.className.match(/l[0-9]/g).length;
                    return a.shiftKey ? c.classList.remove("l" + (d - 1)) : void (d <= 1 && c.previousElementSibling && (0 === d || c.previousElementSibling.classList.contains("l0")) && c.classList.add("l" + d));
                }, 50);
        }
        a.exports = c;
    },
    function (a, b) {
        ...
        function c(a, b, c) {
            var d = b.closest("li"),
                e = null === d.className.match(/l[0-9]/g) ? 0 : d.className.match(/l[0-9]/g).length;
            if (e > 0 && !d.textContent.length) return a.preventDefault(), d.classList.remove("l" + (e - 1)), !1;
        }
        a.exports = c;
    },
    function (a, b, c) {
    ...
    function (a, b) {
        ...
        function c(a, b, c) {
            ...
            return d && c.dom.hidesCursor(d) && c.selection.range.collapsed ? (a.preventDefault(), c.updateContext(d), b.textContent.length || c.dom.removeElement(b), !1) : void 0;
        }
        a.exports = c;
    },
    function (a, b) {
        ...
        function c(a, b, c) {
            if (c.selection.isLastCharacter(b)) {
                ...
                return (d && !c.properties.forElement(d).property("hidesCursor")) || (a.preventDefault(), c.selection.placeCaret(d, { at: "end" })), !1;
            }
        }
        a.exports = c;
    },
    function (a, b) {
        "use strict";
        function c(a, b, c) {
            if (c.selection.isFirstCharacter(b) && c.selection.range.collapsed) {
                var d = c.context.ancestorElement;
                a.preventDefault();
                var e = document.createElement("p");
                (e.innerHTML = b.innerHTML), c.dom.insertBefore(e, d), 1 === d.childElementCount ? c.dom.removeElement(d) : c.dom.removeElement(b), c.selection.placeCaret(e, { at: "start" });
            }
        }
        a.exports = c;
    },
    function (a, b, c) {
        ...
        function e(a, b, c) {
            ...
            if (f) return c.selection.placeCaret(f, { at: "end" }), c.updateContext(f), d(f);
            var g = document.createElement("figcaption");
            (g.innerHTML = "<br/>"), e.appendChild(g), c.updateContext(g), g && (d(g), c.selection.placeCaret(g, { at: "start" }));
        }
        var d = c(225);
        a.exports = e;
    },
    function (a, b, c) {
                ...
                d(a, [
                    {
                        ...
                        value: function () {
                            ...
                            b ? (this.el = b) : ((this.el = document.createElement("div")), this.el.classList.add("fk-ui"), document.body.appendChild(this.el));
                        },
                    },
                ]),
                a
        ...
        (g.prototype.focusComponent = function (a) {
            ...
            b.focus(), b.selection.placeCaret(a, { at: "start" }), b.updateContext(a);
        }),
            (g.prototype.extend = function (a, b) {
                var c = f({ document: this.document, ui: this, tagName: "div", className: "rofl", initialize: function () {}, events: {}, render: function () {} }, b);
                return (
                    ...
                    Object.keys(c.events).forEach(function (a) {
                        ...
                        return d
                            ? [].forEach.call(
                                  ...
                                  function (d) {
                                      d.addEventListener(b, c[c.events[a]].bind(c));
                                  },
                                  !1
                              )
        ...
        function f(a) {
            return d(function (b, c) {
                var d = -1,
                    ...
                    g = f > 1 ? c[f - 1] : void 0,
                    h = f > 2 ? c[2] : void 0;
                for (g = a.length > 3 && "function" == typeof g ? (f--, g) : void 0, h && e(c[0], c[1], h) && ((g = f < 3 ? void 0 : g), (f = 1)), b = Object(b); ++d < f; ) {
                    var i = c[d];
                    i && a(b, i, d, g);
                }
                return b;
    ...
    function (a, b, c) {
        function i(a) {
            ...
            var b = e(a),
                c = [];
            for (var g in a) ("constructor" != g || (!b && h.call(a, g))) && c.push(g);
            return c;
        }
        var d = c(6),
            e = c(40),
            ...
            return (
                (a.toString = function () {
                    for (var b = [], c = 0; c < this.length; c++) {
                        var d = this[c];
                        d[2] ? b.push("@media " + d[2] + "{" + d[1] + "}") : b.push(d[1]);
                    }
                    return b.join("");
                }),
                (a.i = function (b, c) {
    ...
    function (a, b, c) {
        function j(a, b) {
            for (var c = 0; c < a.length; c++) {
                ...
                if (f) {
                    f.refs++;
                    for (var g = 0; g < f.parts.length; g++) f.parts[g](e.parts[g]);
                    for (; g < e.parts.length; g++) f.parts.push(n(e.parts[g], b));
                } else {
                    for (var h = [], g = 0; g < e.parts.length; g++) h.push(n(e.parts[g], b));
        ...
        function n(a, b) {
            ...
            if (b.singleton) {
                var f = i++;
                (c = h || (h = l())), (d = p.bind(null, c, f, !1)), (e = p.bind(null, c, f, !0));
            } else
                a.sourceMap && "function" == typeof URL && "function" == typeof URL.createObjectURL && "function" == typeof URL.revokeObjectURL && "function" == typeof Blob && "function" == typeof btoa
                    ? ((c = m()),
                      (d = r.bind(null, c)),
                      (e = function () {
            ...
            return (
                ...
                function (c) {
                    if (c) {
                        if (c.css === a.css && c.media === a.media && c.sourceMap === a.sourceMap) return;
                        d((a = c));
                    } else e();
                }
            );
        ...
        var d = {},
            ...
            i = 0;
        a.exports = function (a, b) {
            (b = b || {}), "undefined" == typeof b.singleton && (b.singleton = f());
            var c = k(a);
            return (
                j(c, b),
                function (e) {
                    ...
                    for (var g = 0; g < f.length; g++) {
                        var i = f[g];
                        if (0 === i.refs) {
                            for (var m = 0; m < i.parts.length; m++) i.parts[m]();
                            delete d[i.id];
                        }
                    }
                }
    ...
    function (a, b, c) {
        ...
        var d = (function () {
            ...
            i = (function () {
                function a(b) {
                    h(this, a), (this.callbacks = b), (this.supportsSelectionChange = "undefined" != typeof document.onselectionchange), (this.oldRange = document.createRange()), (this.mousePressed = !1), this.bindEvents();
                }
                return (
                    d(a, [
                        {
                            ...
                            value: function () {
                                if (this.supportsSelectionChange) {
                                    var b = this.triggerSelectionChange.bind(this);
                                    document.addEventListener("selectionchange", b);
                                } else
                                    document.addEventListener("mousedown", this.startObserving.bind(this)),
                                        document.addEventListener("mouseup", this.stopObserving.bind(this)),
                                        document.addEventListener("keyup", this.triggerSelectionChange.bind(this));
                                document.addEventListener("keyup", this.triggerSelectionChangeEnd.bind(this)),
                                    document.addEventListener("mouseup", this.triggerSelectionChangeEnd.bind(this)),
                                    document.body.addEventListener("touchend", this.triggerSelectionChangeEnd.bind(this));
                            },
                        },
                        {
                            key: "startObserving",
                            value: function (b) {
                                b.target.closest("[contenteditable].fk-editable") && ((this.mouveMoveListener = this.triggerSelectionChange.bind(this)), document.addEventListener("mousemove", this.mouveMoveListener));
                            },
                        },
                        {
                            key: "stopObserving",
                            value: function (b) {
                                ...
                                (0, f.default)(function () {
                                    ...
                                    document.removeEventListener("mousemove", this.mouveMoveListener);
                            },
                        },
                        {
                            key: "getRange",
                        ...
                        },
                        {
                            key: "sameRange",
                            value: function (b, c) {
                                return ["startContainer", "startOffset", "endContainer", "endOffset"].every(function (a) {
                                    return b[a] === c[a];
                                });
                            },
                        },
                        {
                            ...
                            value: function (b) {
                                var c = this.getRange();
                                this.sameRange(c, this.oldRange) || ((this.oldRange = c), this.callbacks.selectionChange(b, c));
                            },
                        },
                        {
        ...
        (h.prototype.init = function (a) {
            var b = function (c, e) {
                var i,
                    k,
                    h = e.textContent,
                    j = { ">": "blockquote", "######": "h6", "#####": "h5", "####": "h4", "###": "h3", "##": "h2", "---": "hr", "#": "h1", "1.": "ol", "-": "ul", "*": "ul" };
                if (
                    (g(j, function (a, b) {
                        if (0 === h.indexOf(b)) return (k = { element: a, command: b }), !0;
                    }),
                    !k)
                )
                    return !1;
                var l = new RegExp("^" + k.command.replace("*", "\\*"), "gi"),
                    h = h.replace(l, "");
                if ("ul" === k.element || "ol" === k.element) i = a.commands.execute("ol" === k.element ? "insertOrderedList" : "insertUnorderedList");
                else {
                    if (((i = document.createElement(k.element)), "hr" === k.element)) return c.preventDefault(), a.dom.insertBefore(i, e), (e.innerHTML = "<br>");
        ...
        var d =
            ...
            r = (function () {
                function a() {
                    ...
                    (this.lastTriggeredButton = !1), (this.options = d({}, c, b));
                }
                return (
                    e(a, [
                        {
                            ...
                            value: function (b) {
                                ...
                                (this.registeredButtons = this.options.buttons),
                                    ...
                                    (this.bubbleView = new g.default({ data: { maxButtons: b.context.isMobile ? 10 : 7 }, editor: b, plugin: this, el: ".fk-bubble" })),
                                    (this.bubbleView.registeredButtons = this.registeredButtons),
                                    b.on("ui.bubble.toggleButton", function (a) {
                        ...
                        },
                        {
                            ...
                            value: function (b) {
                                return (this.hostElement = document.createElement("div")), (this.hostElement.className = "fk-bubble"), b.appendChild(this.hostElement), this.hostElement;
                            },
                        },
                        {
                            key: "bindEvents",
                            value: function (b) {
                                ...
                                b.on("ui.bubble.hide", this.hide.bind(this)),
                                    ...
                                    b.on("keydown", this.handleKeyDown.bind(this)),
                                    b.on("resize", this.updateUIPosition.bind(this)),
                                    b.on("ui.dots.click", this.handleSelectionchange.bind(this)),
                                    b.context.isMobile ? b.on("selectionchange", this.handleSelectionchange.bind(this)) : b.on("selectionchange.end", this.handleSelectionchange.bind(this)),
                                    b.on("contextChange", this.handleContextChange.bind(this)),
                                    b.on("commandExecuted", function (a) {
                                        c.updateAvailableButtons(a, b.selection.range);
                                    });
                            },
                        },
                        {
                            ...
                            value: function (b) {
                                if (
                                    (9 !== b.keyCode || this.editor.selection.range.collapsed || (b.preventDefault(), this.bubbleView.updateIndex(b.shiftKey ? -1 : 1), (this.bubbleView.isInTabbedMode = !0)),
                                    13 === b.keyCode && this.bubbleView.isInTabbedMode)
                                ) {
                                    var c = this.bubbleView.getFocusedButton();
                                    if ((b.preventDefault(), c)) {
                                        this.lastTriggeredButton = c;
                                        for (var d = null, e = 1; !d; ) (d = c["__v_repeat_" + e]), e++;
                                        d.$options.methods.handleClick.call(d, b);
                                    }
                                }
                            },
                        },
                        {
                            ...
                            value: function () {
                                this.editor.context.properties.hidesCursor && (this.show(), this.updateAvailableButtons()), this.updateUIPosition();
                            },
                        },
                        {
                            key: "show",
                            value: function () {
                                (this.bubbleView.isVisible = !0), this.updateUIPosition(), this.editor.emit("ui.bubble.show", this), document.addEventListener("touchmove", this.updateUIPosition.bind(this));
                            },
                        },
                        {
                            key: "hide",
                            value: function (b) {
                                (("blur" !== b.type && "focus" !== b.type) || !this.bubbleView.expandedButton) &&
                                    (this.bubbleView.expandedButton && this.bubbleView.closeExpandedButton("hide"),
                                    (this.lastTriggeredButton = !1),
                                    (this.bubbleView.isInTabbedMode = !1),
                                    (this.bubbleView.buttonIndex = -1),
                                    this.bubbleView.buttons.forEach(function (a) {
                                        a.focused = !1;
                                    }),
                                    (this.bubbleView.isVisible = !1),
                                    (this.bubbleView.expandedButton = null),
                                    document.removeEventListener("touchmove", this.updateUIPosition.bind(this)));
                            },
                        },
                        {
                            key: "updateUIPosition",
                            value: function () {
                                this.bubbleView.isVisible && (this.bubbleView.selectionCoords = this.getAnchorArea());
                            },
                        },
                        {
                            key: "getAnchorArea",
                            value: function () {
                                var b = this.editor.context,
                                    c = b.properties.hidesCursor ? b.closestElementWithRules : window.getSelection().getRangeAt(0);
                                return this.bubbleView.expandedButton && (c = document.querySelector(".fk-selected-link")), c ? (this.lastElementOrRange = c) : (c = this.lastElementOrRange), (0, i.default)(c);
                            },
                        },
                        {
                            key: "registerButton",
                        ...
                        },
                        {
                            ...
                            value: function () {
                                var b = window.getSelection();
                                return b.rangeCount ? b.getRangeAt(0).cloneRange() : { collapsed: !0 };
                            },
                        },
                        {
                            ...
                            value: function (b) {
                                ...
                                (this.savedRange = this.getRange()),
                                    this.savedRange.collapsed || this.updateUIPosition(),
                                    setTimeout(function () {
                                        return c.getRange().collapsed ? c.hide(b) : void (9 !== b.keyCode && 16 !== b.keyCode && c.updateAvailableButtons(b, c.savedRange));
                                    }, 20);
                            },
                        },
                        {
                            key: "sameButtons",
                            value: function (b, c) {
                                var d = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : "icon";
                                return (0, m.default)(b, d).join("") === (0, m.default)(c, d).join("");
                            },
                        },
                        {
                        ...
                        },
                        {
                            ...
                            value: function () {
                                var b = window.getSelection();
                                b.rangeCount && (this.savedRange = b.getRangeAt(0).cloneRange());
                            },
                        },
                        {
                            ...
                            value: function (b) {
                                var c = this,
                                    ...
                                    e = this.editor.context.properties.allowedCommands;
                                return (
                                    (this.selectionType = this.editor.context.properties.hidesCursor ? "full" : this.editor.selection.getType(b)),
                                    d && e
                                        ? (0, k.default)(
                                              this.registeredButtons,
                                              function (a, b) {
                                                  if (((b.focused = c.lastTriggeredButton === b), e.indexOf(b.name) > -1)) {
                                                      var d = b.selectionType ? b.selectionType : ["full"];
                                                      d.indexOf(c.selectionType) > -1 && (!b.isVisible || (b.isVisible && b.isVisible(c.editor.context))) && ((b.active = !!b.isActive(c.editor)), a.push(b));
                                                  }
                                                  return a;
                                              },
                                              []
                        ...
                        },
                        {
                            ...
                            value: function (b, c) {
                                ...
                                return d.length ? (this.sameButtons(this.bubbleView.buttons, d) || ((this.bubbleView.buttons = d), (this.bubbleView.startButton = 0)), this.show()) : this.hide(b);
                            },
                        },
                        {
                            ...
                            value: function (b) {
                                var c = this;
                                this.bubbleView.buttons.forEach(function (a, d) {
                                    (a.active = !!a.isActive(c.editor)), b === a && ((c.bubbleView.buttonIndex = d), (a.focused = !0));
                                });
                            },
                        },
                    ]),
    ...
    function (a, b, c) {
        ...
        var i = e.default.extend({
            ...
            data: function () {
                return { isVisible: !1, startButton: 0, buttonIndex: -1, maxButtons: 5, croppedOn: !1, expandedButton: null, buttons: [], selectionCoords: {}, isInTabbedMode: !1, bubblePosition: {} };
            },
            watch: {
                "[selectionCoords.top, selectionCoords.left, expandedButton, startButton]": function (b) {
                    var c = this;
                    e.default.nextTick(function () {
                        var a = [c.selectionCoords.left, c.selectionCoords.top],
                            b = a[0],
                            d = a[1],
                            e = c.$$.bubble,
                            f = e.getBoundingClientRect(),
                            g = f.width / 2;
                        (b = c.selectionCoords.left - g + c.selectionCoords.width / 2),
                            b < 0 ? ((c.croppedOn = "left"), (b = 0)) : b + f.width > window.innerWidth ? ((c.croppedOn = "right"), (b = window.innerWidth - f.width)) : (c.croppedOn = !1),
                            (d = c.$options.editor.context.isMobile ? window.scrollY : c.selectionCoords.top - f.height - 10),
                            (c.bubblePosition = { top: d + "px", left: b + "px" });
                    });
                },
            },
            computed: {
                trianglePosition: function () {
                    ...
                    if (this.croppedOn && b) {
                        var c = b.getBoundingClientRect(),
                            d = this.selectionCoords.left + this.selectionCoords.width / 2,
                            e = c.left + c.width / 2,
                            f = d - e;
                ...
                classes: function () {
                    return { "fk-bubble": !0, "fk-bubble--visible": this.isVisible, "fk-bubble--top": this.hasNativeBubble };
                },
                hasPrev: function () {
                    return this.startButton > 0;
                },
                hasNext: function () {
                    return this.buttons.length > this.startButton + this.maxButtons;
                },
            },
            methods: {
                nextPage: function () {
                    this.startButton = Math.min(this.buttons.length - this.maxButtons, this.startButton + this.maxButtons);
                },
                prevPage: function () {
                    this.startButton = Math.max(0, this.startButton - this.maxButtons);
                },
                expand: function (b) {
                    b.onExpand && this.expandButton(b), (this.expandedButton = b);
                },
                preventMouseDown: function (b) {
                    /fk-bubble__link-prompt__input/.test(b.target.className) || b.preventDefault();
                },
                ...
                expandButton: function (b) {
                    return b.onExpand(this.$options.editor), this.saveSelection();
                },
                toggleButton: function (b) {
                    var c = this;
                    this.buttons.forEach(function (a) {
                        a.name === b && (c.expandedButton === a ? c.closeExpandedButton() : c.expand(a));
                    });
                },
                ...
                updateIndex: function (b) {
                    ...
                    (this.buttonIndex = this.buttonIndex + b),
                        (this.buttonIndex = this.buttonIndex >= this.buttons.length ? 0 : this.buttonIndex),
                        (this.buttonIndex = this.buttonIndex < 0 ? this.buttons.length - 1 : this.buttonIndex),
                ...
                closeExpandedButton: function () {
                    if (this.expandedButton && this.expandedButton.onCollapse) {
                        ...
                        this.restoreSelection(), this.expandedButton.onCollapse(this.$options.editor, b);
                    }
                ...
                executeCommand: function (b, c) {
                    ...
                    this.$options.plugin.restoreSelection(),
                        b.command.constructor === String ? d.commands.execute.apply(d.commands, b.command.split(":"), c) : b.command(d, c),
                        (this.expandedButton = null),
                        this.saveSelection(),
    ...
    function (a, b, c) {
        ...
        var d = c(264),
            e = d.extend;
        e(f, c(272)), (f.options = { replace: !0, directives: c(288), elementDirectives: c(310), filters: c(313), transitions: {}, components: {}, partials: {} });
        var g = f.prototype;
    ...
    function (a, b, c) {
        var d = c(265),
            e = d.extend;
        e(b, d), e(b, c(266)), e(b, c(267)), e(b, c(269)), e(b, c(270)), e(b, c(271));
    },
    function (a, b) {
        function c(a, b) {
        ...
        (b.isPlainObject = function (a) {
            ...
            (b.looseEqual = function (a, c) {
                return a == c || (!(!b.isObject(a) || !b.isObject(c)) && JSON.stringify(a) === JSON.stringify(c));
            });
    },
    function (a, b) {
        b.hasProto = "__proto__" in {};
        var c = (b.inBrowser = "undefined" != typeof window && "[object Object]" !== Object.prototype.toString.call(window));
        if (((b.isIE9 = c && navigator.userAgent.toLowerCase().indexOf("msie 9.0") > 0), (b.isAndroid = c && navigator.userAgent.toLowerCase().indexOf("android") > 0), c && !b.isIE9)) {
            var d = void 0 === window.ontransitionend && void 0 !== window.onwebkittransitionend,
                e = void 0 === window.onanimationend && void 0 !== window.onwebkitanimationend;
            (b.transitionProp = d ? "WebkitTransition" : "transition"),
                (b.transitionEndEvent = d ? "webkitTransitionEnd" : "transitionend"),
                (b.animationProp = e ? "WebkitAnimation" : "animation"),
                (b.animationEndEvent = e ? "webkitAnimationEnd" : "animationend");
        }
        b.nextTick = (function () {
            function d() {
                b = !1;
    ...
    function (a, b, c) {
        (function (a) {
            ...
            (b.query = function (b) {
                if ("string" == typeof b) {
                    var c = b;
                    (b = document.querySelector(b)), b || ("production" !== a.env.NODE_ENV && d.warn("Cannot find element: " + c));
                }
                return b;
            }),
                (b.inDoc = function (a) {
                ...
                (b.after = function (a, c) {
                    c.nextSibling ? b.before(a, c.nextSibling) : c.parentNode.appendChild(a);
                }),
                (b.remove = function (a) {
                ...
                (b.extractContent = function (a, c) {
                    var d, e;
                    if ((b.isTemplate(a) && a.content instanceof DocumentFragment && (a = a.content), a.hasChildNodes()))
                        for (b.trimNode(a), e = c ? document.createDocumentFragment() : document.createElement("div"); (d = a.firstChild); ) e.appendChild(d);
                    return e;
                }),
                ...
                (b.createAnchor = function (a, b) {
                    return e.debug ? document.createComment(a) : document.createTextNode(b ? " " : "");
                });
        }.call(b, c(162)));
    },
    function (a, b) {
    ...
    function (a, b, c) {
        (function (a) {
            function h(a, b) {
                var c, e, f;
                for (c in b) (e = a[c]), (f = b[c]), a.hasOwnProperty(c) ? d.isObject(e) && d.isObject(f) && h(e, f) : a.$add(c, f);
                return a;
            }
            function i(a, b) {
            ...
            function k(b) {
                if (b.components)
                    for (var e, c = (b.components = m(b.components)), f = Object.keys(c), g = 0, h = f.length; g < h; g++) {
                        var i = f[g];
                        d.commonTagRE.test(i)
                            ? "production" !== a.env.NODE_ENV && d.warn("Do not use built-in HTML elements as component id: " + i)
                            : ((e = c[i]), d.isPlainObject(e) && ((e.id = e.id || i), (c[i] = e._Ctor || (e._Ctor = d.Vue.extend(e)))));
                    }
            }
            function l(a) {
                var b = a.props;
                d.isPlainObject(b)
                    ? (a.props = Object.keys(b).map(function (a) {
                          var c = b[a];
                          return d.isPlainObject(c) || (c = { type: c }), (c.name = a), c;
                      }))
                    : d.isArray(b) &&
            ...
            function m(b) {
                if (d.isArray(b)) {
                    for (var f, c = {}, e = b.length; e--; ) {
                        ...
                        g ? (c[g] = f) : "production" !== a.env.NODE_ENV && d.warn("Array-syntax assets must provide an id field.");
                    }
                    return c;
                }
                return b;
            ...
            (g.data = function (b, c, e) {
                    ...
                    ? b || c
                        ? function () {
                              var d = "function" == typeof c ? c.call(e) : c,
                                  f = "function" == typeof b ? b.call(e) : void 0;
                              return d ? h(d, f) : f;
                          }
                        : void 0
                    : c
                    ? "function" != typeof c
                        ? ("production" !== a.env.NODE_ENV && d.warn('The "data" option should be a function that returns a per-instance value in component definitions.'), b)
                        : b
                        ? function () {
                ...
                (g.el = function (b, c, e) {
                    if (!e && c && "function" != typeof c) return void ("production" !== a.env.NODE_ENV && d.warn('The "el" option should be a function that returns a per-instance value in component definitions.'));
                    var f = c || b;
                    return e && "function" == typeof f ? f.call(e) : f;
                }),
                (g.created = g.ready = g.attached = g.detached = g.beforeCompile = g.compiled = g.beforeDestroy = g.destroyed = g.props = function (a, b) {
                    return b ? (a ? a.concat(b) : d.isArray(b) ? b : [b]) : a;
                }),
                (g.paramAttributes = function () {
                    "production" !== a.env.NODE_ENV && d.warn('"paramAttributes" option has been deprecated in 0.12. Use "props" instead.');
                }),
                e._assetTypes.forEach(function (a) {
                    g[a + "s"] = i;
                }),
                (g.watch = g.events = function (a, b) {
                    if (!b) return a;
                    if (!a) return b;
                    var c = {};
                    f(c, a);
                    for (var e in b) {
                        var g = c[e],
                            h = b[e];
                        g && !d.isArray(g) && (g = [g]), (c[e] = g ? g.concat(h) : [h]);
                    }
                    return c;
                }),
                (g.methods = g.computed = function (a, b) {
                    if (!b) return a;
                    if (!a) return b;
                    var c = Object.create(a);
                    return f(c, b), c;
            ...
            (b.mergeOptions = function a(b, c, d) {
                ...
                var f,
                    e = {};
                if (c.mixins) for (var h = 0, i = c.mixins.length; h < i; h++) b = a(b, c.mixins[h], d);
                for (f in b) m(f);
                for (f in c) b.hasOwnProperty(f) || m(f);
                return e;
            }),
                (b.resolveAsset = function (b, c, f) {
                    for (var g = d.camelize(f), h = g.charAt(0).toUpperCase() + g.slice(1), i = b[c], j = i[f] || i[g] || i[h]; !j && b._parent && (!e.strict || b._repeat); )
                        (b = (b._context || b._parent).$options), (i = b[c]), (j = i[f] || i[g] || i[h]);
                    return j;
                });
        }.call(b, c(162)));
    },
    function (a, b, c) {
        (function (a) {
            ...
            var d = c(264);
            (b.commonTagRE = /^(div|p|span|img|a|br|ul|ol|li|h1|h2|h3|h4|h5|code|pre)$/),
                (b.checkComponent = function (a, c) {
                    ...
                    return !b.commonTagRE.test(e) && d.resolveAsset(c, "components", e) ? e : (e = d.attr(a, "component")) ? e : void 0;
                }),
                (b.initProp = function (a, c, e) {
                    if (b.assertProp(c, e)) {
                        var f = c.path;
                        f in a ? d.define(a, f, e, !0) : (a[f] = e), (a._data[f] = e);
                    }
                }),
                    ...
                    if (
                        (h &&
                            (h === String
                                ...
                                : h === Function
                                ? ((j = "function"), (i = "function" == typeof c))
                                : h === Object
                        ...
                        return "production" !== a.env.NODE_ENV && d.warn("Invalid prop: type check failed for " + b.path + '="' + b.raw + '". Expected ' + e(j) + ", got " + f(c) + "."), !1;
                    var k = g.validator;
                    return !(k && !k.call(null, c)) || ("production" !== a.env.NODE_ENV && d.warn("Invalid prop: custom validator check failed for " + b.path + '="' + b.raw + '"'), !1);
                });
        }.call(b, c(162)));
    },
    function (a, b, c) {
            ...
            if ("production" !== a.env.NODE_ENV) {
                ...
                (b.log = function (a) {
                    ...
                    (b.assertAsset = function (a, c, d) {
                        if ("directive" === c) {
                            if ("with" === d) return void b.warn("v-with has been deprecated in ^0.12.0. Use props instead.");
                            if ("events" === d) return void b.warn("v-events has been deprecated in ^0.12.0. Pass down methods as callback props instead.");
                        }
    ...
    function (a, b, c) {
        function g(a) {
            return new Function("return function " + d.classify(a) + " (options) { this._init(options) }")();
        }
        var d = c(264),
            e = c(268);
        (b.util = d), (b.config = e), (b.nextTick = d.nextTick), (b.compiler = c(273)), (b.parsers = { path: c(283), text: c(276), template: c(285), directive: c(278), expression: c(282) }), (b.cid = 0);
        var f = 1;
        (b.extend = function (a) {
            a = a || {};
            var b = this,
            ...
            e._assetTypes.forEach(function (a) {
                b[a] = function (b, c) {
                    return c ? ("component" === a && d.isPlainObject(c) && ((c.name = b), (c = d.Vue.extend(c))), void (this.options[a + "s"][b] = c)) : this.options[a + "s"][b];
                };
            });
    },
    function (a, b, c) {
    ...
    function (a, b, c) {
        (function (a) {
            ...
            function p(a, b) {
                var c = a.nodeType;
                return 1 === c && "SCRIPT" !== a.tagName ? q(a, b) : 3 === c && f.interpolate && a.data.trim() ? r(a, b) : null;
            }
            function q(a, b) {
                "TEXTAREA" === a.tagName && g.parse(a.value) && a.setAttribute("value", a.value);
                var c,
                    d = a.hasAttributes();
                return d && (c = y(a, b)), c || (c = w(a, b)), c || (c = x(a, b)), !c && d && (c = B(a.attributes, b)), c;
            }
            function r(a, b) {
                var c = g.parse(a.data);
                if (!c) return null;
                for (var e, f, d = document.createDocumentFragment(), h = 0, i = c.length; h < i; h++) (f = c[h]), (e = f.tag ? s(f, b) : document.createTextNode(f.value)), d.appendChild(e);
                return t(c, d, b);
            }
            function s(a, b) {
                function d(c) {
                    (a.type = c), (a.def = j(b, "directives", c)), (a.descriptor = h.parse(a.value)[0]);
                }
                var c;
                return a.oneTime ? (c = document.createTextNode(a.value)) : a.html ? ((c = document.createComment("v-html")), d("html")) : ((c = document.createTextNode(" ")), d("text")), c;
            }
            function t(a, b) {
                return function (e, f) {
                    for (var j, k, l, g = b.cloneNode(!0), h = d.toArray(g.childNodes), m = 0, n = a.length; m < n; m++)
                        (j = a[m]), (k = j.value), j.tag && ((l = h[m]), j.oneTime ? ((k = e.$eval(k)), j.html ? d.replace(l, i.parse(k, !0)) : (l.data = k)) : e._bindDir(j.type, l, j.descriptor, j.def));
                    d.replace(f, g);
                };
            }
            function u(a, b) {
                for (var d, e, f, c = [], g = 0, h = a.length; g < h; g++) (f = a[g]), (d = p(f, b)), (e = (d && d.terminal) || "SCRIPT" === f.tagName || !f.hasChildNodes() ? null : u(f.childNodes, b)), c.push(d, e);
            ...
            function y(a, b) {
                ...
                for (var c, e, f = 0, g = l.length; f < g; f++) if (((e = l[f]), null !== (c = d.attr(a, e)))) return A(a, e, c, b);
            }
            function z() {}
                ...
                for (var i, k, l, m, n, o, e = b.length, g = []; e--; )
                    (i = b[e]),
                        ...
                        0 === k.indexOf(f.prefix)
                            ? ((n = k.slice(f.prefix.length)), (o = j(c, "directives", n)), "production" !== a.env.NODE_ENV && d.assertAsset(o, "directive", n), o && g.push({ name: n, descriptors: h.parse(l), def: o }))
                            : f.interpolate && ((m = D(k, l, c)), m && g.push(m));
            ...
            function C(a) {
                return function (c, d, e) {
                    for (var g, h, i, f = a.length; f--; )
                        ...
                        else for (i = g.descriptors.length, h = 0; h < i; h++) c._bindDir(g.name, d, g.descriptors[h], g.def, e);
                };
            }
            function D(a, b, c) {
                var d = g.parse(b),
                    e = "class" === a;
                if (d) {
                    for (var f = e ? "class" : "attr", i = c.directives[f], j = d.length, k = !0; j--; ) {
                        var l = d[j];
                        l.tag && !l.oneTime && (k = !1);
                    }
                    var m;
                        ...
                        (m = k
                            ...
                            : function (c, j) {
                                  var k = g.tokensToExp(d, c),
                                      l = e ? h.parse(k)[0] : h.parse(a + ":" + k)[0];
                                  e && (l._rawClass = b), c._bindDir(f, j, l, i);
                              }),
                        { def: i, _link: m }
                    );
                }
            ...
            (b.compile = function (a, b, c) {
                var e = c || !b._asComponent ? p(a, b) : null,
                    f = (e && e.terminal) || "SCRIPT" === a.tagName || !a.hasChildNodes() ? null : u(a.childNodes, b);
                return function (b, c, g) {
                ...
                (b.compileRoot = function (a, b) {
                    var e,
                        ...
                        d = b._replacerAttrs;
                    return (
                        11 !== a.nodeType && (b._asComponent ? (c && (e = B(c, b)), d && (f = B(d, b))) : (f = B(a.attributes, b))),
                        function (b, c) {
                            var g,
                                d = b._context;
                            d &&
        ...
        (function (b) {
            function l(a) {
                return function (e, h) {
                    ...
                    for (var j, k, l, n, i = a.length; i--; )
                        if (((j = a[i]), (k = j.path), (e._props[k] = j), (l = j.options), null === j.raw)) d.initProp(e, j, m(l));
                        else if (j.dynamic)
                            e._context
                                ? j.mode === g.ONE_TIME
                                    ? ((n = e._context.$get(j.parentPath)), d.initProp(e, j, n))
                                    : e._bindDir("prop", h, j, f)
                                : "production" !== b.env.NODE_ENV && d.warn("Cannot bind dynamic prop on a root instance with no parent: " + j.name + '="' + j.raw + '"');
                        else {
                            var o = j.raw;
                            (n = (l.type === Boolean && "" === o) || (o.trim() ? d.toBoolean(d.toNumber(o)) : o)), d.initProp(e, j, n);
                        }
                };
            }
            function m(a) {
                if (!a.hasOwnProperty("default")) return a.type !== Boolean && void 0;
                var c = a.default;
                return (
                    d.isObject(c) && "production" !== b.env.NODE_ENV && d.warn("Object/Array as default prop values will be shared across multiple instances. Use a factory function to return the default value instead."),
            ...
            a.exports = function (c, f) {
                for (var o, p, q, r, s, t, u, v, m = [], n = f.length; n--; )
                    if (((o = f[n]), (p = o.name), (s = d.camelize(p.replace(i, ""))), h.test(s))) {
                        if (((q = d.hyphenate(p)), (r = c.getAttribute(q)), null === r && ((q = "data-" + q), (r = c.getAttribute(q))), (t = { name: p, raw: r, path: s, options: o, mode: g.ONE_WAY }), null !== r)) {
                            c.removeAttribute(q);
                            var w = e.parse(r);
                            w &&
                                ((t.dynamic = !0),
                                ...
                                u || (v && w[0].oneTime)
                                    ? (t.mode = g.ONE_TIME)
                                    : !u && v && w[0].twoWay && (j.test(t.parentPath) ? (t.mode = g.TWO_WAY) : "production" !== b.env.NODE_ENV && d.warn("Cannot bind two-way prop with non-settable parent path: " + t.parentPath)),
                                "production" !== b.env.NODE_ENV && o.twoWay && t.mode !== g.TWO_WAY && d.warn('Prop "' + p + '" expects a two-way binding type.'));
                        } else o && o.required && "production" !== b.env.NODE_ENV && d.warn("Missing required prop: " + p);
                        m.push(t);
                    } else "production" !== b.env.NODE_ENV && d.warn('Invalid prop key: "' + p + '". Prop keys must be valid identifiers.');
                return l(m);
            };
        }.call(b, c(162)));
    },
    function (a, b, c) {
        ...
        function n() {
            ...
            var c = m(k),
                ...
                g = m(a),
                n = m(b);
            (i = new RegExp(c + "?" + g + "(.+?)" + n + f + "?", "g")), (j = new RegExp("^" + c + g + ".*" + n + f + "$")), (h = new d(1e3));
        }
        function o(a, b, c) {
            return a.tag ? (b && a.oneTime ? '"' + b.$eval(a.value) + '"' : q(a.value, c)) : '"' + a.value + '"';
        }
        function q(a, b) {
            if (p.test(a)) {
                var c = f.parse(a)[0];
        ...
        (b.parse = function (a) {
            ...
            for (var f, g, k, l, m, o, c = [], d = (i.lastIndex = 0); (f = i.exec(a)); )
                (g = f.index),
                    ...
                    c.push({ tag: !0, value: k.trim(), html: j.test(f[0]), oneTime: m, twoWay: o }),
                    (d = g + f[0].length);
            return d < a.length && c.push({ value: a.slice(d) }), h.put(a, c), c;
        }),
                ...
                if (void 0 !== c)
                    return c === this.tail
                        ? b
                            ? c
                            : c.value
                        : (c.newer && (c === this.head && (this.head = c.newer), (c.newer.older = c.older)),
    ...
    function (a, b, c) {
        function y() {
            (v.raw = j.slice(s, l).trim()), void 0 === v.expression ? (v.expression = j.slice(t, l).trim()) : w !== s && z(), (0 === l || v.expression) && u.push(v);
        }
        function z() {
            var b,
                a = j.slice(w, l).trim();
        ...
        b.parse = function (a) {
            var b = f.get(a);
            if (b) return b;
            for (j = a, n = o = !1, p = q = r = s = t = 0, w = 0, u = [], v = {}, x = null, l = 0, m = j.length; l < m; l++)
                if (((k = j.charCodeAt(l)), n)) 39 === k && (n = !n);
                else if (o) 34 === k && (o = !o);
                else if (44 !== k || r || p || q)
                    if (58 !== k || v.expression || v.arg)
                        if (124 === k && 124 !== j.charCodeAt(l + 1) && 124 !== j.charCodeAt(l - 1)) void 0 === v.expression ? ((w = l + 1), (v.expression = j.slice(t, l).trim())) : z();
                        else
                            switch (k) {
                                case 34:
                                    o = !0;
                    ...
                    else (x = j.slice(s, l).trim()), g.test(x) && ((t = l + 1), (v.arg = d.stripQuotes(x) || x));
                else y(), (v = {}), (s = t = w = l + 1);
    ...
    function (a, b, c) {
        (function (b) {
            ...
            function k(a) {
                var b, c, e;
                for (b in a)
                    if (((c = a[b]), d.isArray(c))) for (e = c.length; e--; ) k(c[e]);
            ...
            (j.prototype.addDep = function (a) {
                ...
                (j.prototype.get = function () {
                    ...
                    try {
                        ...
                        "production" !== b.env.NODE_ENV && e.warnExpressionErrors && d.warn('Error when evaluating expression "' + this.expression + '". ' + (e.debug ? "" : "Turn on debug mode to see stack trace."), a);
                    }
                    return this.deep && k(c), this.preProcess && (c = this.preProcess(c)), this.filters && (c = a._applyFilters(c, null, this.filters, !1)), this.afterGet(), c;
                }),
                (j.prototype.set = function (a) {
                    var c = this.vm;
                    this.filters && (a = c._applyFilters(a, this.value, this.filters, !0));
                    try {
                        this.setter.call(c, c, a);
                    } catch (a) {
                        "production" !== b.env.NODE_ENV && e.warnExpressionErrors && d.warn('Error when evaluating setter "' + this.expression + '"', a);
                    }
                }),
                ...
                (j.prototype.update = function (a) {
                    this.lazy
                        ...
                        : this.sync || !e.async
                        ? this.run()
                        : ((this.shallow = this.queued ? !!a && this.shallow : !!a), (this.queued = !0), "production" !== b.env.NODE_ENV && e.debug && (this.prevError = new Error("[vue] async stack trace")), h.push(this));
                }),
                (j.prototype.run = function () {
                    if (this.active) {
                        var a = this.get();
                        if (a !== this.value || ((d.isArray(a) || this.deep) && !this.shallow)) {
                            var c = this.value;
                            this.value = a;
                            var f = this.prevError;
                            if ("production" !== b.env.NODE_ENV && e.debug && f) {
                                this.prevError = null;
                                try {
                ...
                (j.prototype.evaluate = function () {
                    var a = f.target;
                    (this.value = this.get()), (this.dirty = !1), (f.target = a);
                }),
    ...
    function (a, b, c) {
        ...
        (f.target = null),
            ...
            (f.prototype.notify = function () {
                for (var a = d.toArray(this.subs), b = 0, c = a.length; b < c; b++) a[b].update();
            }),
            (a.exports = f);
    },
    function (a, b, c) {
        (function (a) {
            ...
            function u(a) {
                var b = a.charAt(0),
                    c = a.slice(1);
                return i.test(c) ? a : ((c = c.indexOf('"') > -1 ? c.replace(o, v) : c), b + "scope." + c);
            }
            function v(a, b) {
                return s[b];
            }
            function w(b, c) {
                k.test(b) && "production" !== a.env.NODE_ENV && d.warn("Avoid using reserved keywords in expression: " + b), (s.length = 0);
            ...
            function x(a) {
                var b, c;
                return (
                    a.indexOf("[") < 0 ? ((c = a.split(".")), (c.raw = a), (b = e.compileGetter(c))) : ((c = e.parse(a)), (b = c.get)),
                    {
                        get: b,
                        set: function (a, b) {
                            e.set(a, c, b);
            ...
            function y(b) {
                try {
                    ...
                    "production" !== a.env.NODE_ENV && d.warn("Invalid expression. Generated function body: " + b);
                }
            }
            function z(b) {
                try {
                    ...
                    "production" !== a.env.NODE_ENV && d.warn("Invalid setter function body: " + b);
                }
            }
            function A(a) {
            ...
            var d = c(264),
                ...
                f = c(277),
                g = new f(1e3),
                h = "Math,Date,this,true,false,null,undefined,Infinity,NaN,isNaN,isFinite,decodeURI,decodeURIComponent,encodeURI,encodeURIComponent,parseInt,parseFloat",
                ...
                l = /\s/g,
                m = /\n/g,
                n = /[\{,]\s*[\w\$_]+\s*:|('[^']*'|"[^"]*")|new |typeof |void /g,
                o = /"(\d+)"/g,
                p = /^[A-Za-z_$][\w$]*(\.[A-Za-z_$][\w$]*|\['.*?'\]|\[".*?"\]|\[\d+\]|\[[A-Za-z_$][\w$]*\])*$/,
                q = /[^\w$\.]([A-Za-z_$][\w$]*(\.[A-Za-z_$][\w$]*|\['.*?'\]|\[".*?"\])*)/g,
                r = /^(true|false)$/,
                s = [];
    ...
    function (a, b, c) {
        (function (a) {
            ...
            function y(a) {
                function p() {
                    var b = a[c + 1];
                    if ((d === q && "'" === b) || (d === r && '"' === b)) return c++, (f = b), o[h](), !0;
                }
                var e,
                    f,
                    g,
                ...
                for (
                    ...
                    if ((c++, (e = a[c]), "\\" !== e || !p())) {
                        if (((k = x(e)), (n = w[d]), (l = n[k] || n.else || v), l === v)) return;
                        if (((d = l[0]), (m = o[l[1]]), m && ((f = l[2]), (f = void 0 === f ? e : "*" === f ? f + e : f), m()), d === u)) return (b.raw = a), b;
                    }
            }
            function z(a) {
                return g.test(a) ? "." + a : +a === a >>> 0 ? "[" + a + "]" : "*" === a.charAt(0) ? "[o" + z(a.slice(1)) + "]" : '["' + a.replace(/"/g, '\\"') + '"]';
            }
            function A(b) {
                "production" !== a.env.NODE_ENV &&
                    d.warn('You are setting a non-existent path "' + b.raw + '" on a vm instance. Consider pre-initializing the property with the "data" option for more reliable reactivity and better performance.');
            }
            var d = c(264),
                e = c(277),
                f = new e(1e3),
            ...
            (w[j] = { ws: [j], ident: [m, h], "[": [n], eof: [u] }),
                (w[k] = { ws: [k], ".": [l], "[": [n], eof: [u] }),
                (w[l] = { ws: [l], ident: [m, h] }),
                (w[m] = { ident: [m, h], 0: [m, h], number: [m, h], ws: [k, i], ".": [l, i], "[": [n, i], eof: [u, i] }),
                (w[n] = { ws: [n], 0: [o, h], number: [p, h], "'": [q, h, ""], '"': [r, h, ""], ident: [s, h, "*"] }),
                (w[o] = { ws: [t, i], "]": [k, i] }),
                (w[p] = { 0: [p, h], number: [p, h], ws: [t], "]": [k, i] }),
                (w[q] = { "'": [t], eof: v, else: [q, h] }),
                (w[r] = { '"': [t], eof: v, else: [r, h] }),
                (w[s] = { ident: [s, h], 0: [s, h], number: [s, h], ws: [t], "]": [k, i] }),
                (w[t] = { ws: [t], "]": [k, i] }),
                ...
                (b.parse = function (a) {
                    var c = f.get(a);
                    return c || ((c = y(a)), c && ((c.get = b.compileGetter(c)), f.put(a, c))), c;
                }),
                (b.get = function (a, c) {
                ...
                (b.set = function (a, c, e) {
                    var f = a;
                    if (("string" == typeof c && (c = b.parse(c)), !c || !d.isObject(a))) return !1;
                    for (var g, h, i = 0, j = c.length; i < j; i++)
                        (g = a), (h = c[i]), "*" === h.charAt(0) && (h = f[h.slice(1)]), i < j - 1 ? ((a = a[h]), d.isObject(a) || (A(c), (a = {}), g.$add(h, a))) : d.isArray(a) ? a.$set(h, e) : h in a ? (a[h] = e) : (A(c), a.$add(h, e));
                    return !0;
                });
        }.call(b, c(162)));
    },
        ...
        (function (a) {
            ...
            function n(b) {
                for (var c = 0; c < b.length; c++) {
                    ...
                    (h[g] = null),
                        ...
                        "production" !== a.env.NODE_ENV &&
                            null != h[g] &&
                            ((i[g] = (i[g] || 0) + 1), i[g] > e._maxUpdateCount && (b.splice(h[g], 1), d.warn("You may have an infinite update loop for watcher with expression: " + f.expression)));
                }
            }
            var d = c(264),
                e = c(268),
            ...
            b.push = function (a) {
                ...
                if (null == h[b]) {
                    ...
                    var c = a.user ? g : f;
                    (h[b] = c.length), c.push(a), j || ((j = !0), d.nextTick(m));
                }
            };
        }.call(b, c(162)));
    },
    function (a, b, c) {
        ...
        function m(a) {
            ...
            for (var f, c = b.clone(a), e = document.createDocumentFragment(); (f = c.firstChild); ) e.appendChild(f);
        ...
        var d = c(264),
            ...
            f = new e(1e3),
            g = new e(1e3),
            h = { _default: [0, "", ""], legend: [1, "<fieldset>", "</fieldset>"], tr: [2, "<table><tbody>", "</tbody></table>"], col: [2, "<table><tbody></tbody><colgroup>", "</colgroup></table>"] };
        (h.td = h.th = [3, "<table><tbody><tr>", "</tr></tbody></table>"]),
            (h.option = h.optgroup = [1, '<select multiple="multiple">', "</select>"]),
            (h.thead = h.tbody = h.colgroup = h.caption = h.tfoot = [1, "<table>", "</table>"]),
            (h.g = h.defs = h.symbol = h.use = h.image = h.text = h.circle = h.ellipse = h.line = h.path = h.polygon = h.polyline = h.rect = [
                1,
        ...
        (b.clone = function (a) {
            ...
            if (n) {
                var g = c;
                if ((i(a) && ((a = a.content), (g = c.content)), (e = a.querySelectorAll("template")), e.length)) for (f = g.querySelectorAll("template"), d = f.length; d--; ) f[d].parentNode.replaceChild(b.clone(e[d]), f[d]);
            }
            if (o)
                if ("TEXTAREA" === a.tagName) c.value = a.value;
                else if (((e = a.querySelectorAll("textarea")), e.length)) for (f = c.querySelectorAll("textarea"), d = f.length; d--; ) f[d].value = e[d].value;
            return c;
        }),
            (b.parse = function (a, c, e) {
                ...
                return a instanceof DocumentFragment
                    ...
                    : ("string" == typeof a ? (e || "#" !== a.charAt(0) ? (h = l(a)) : ((h = g.get(a)), h || ((f = document.getElementById(a.slice(1))), f && ((h = m(f)), g.put(a, h))))) : a.nodeType && (h = m(a)), h && c ? b.clone(h) : h);
            });
    },
    function (a, b, c) {
        (function (b) {
            ...
            a.exports = {
                ...
                bind: function () {
                    this.el.__vue__
                        ? "production" !== b.env.NODE_ENV && d.warn('cannot mount component "' + this.expression + '" on already mounted element: ' + this.el)
                        : ((this.anchor = d.createAnchor("v-component")),
                          ...
                          null !== this._checkParam("inline-template") && (this.template = d.extractContent(this.el, !0)),
                          (this.pendingComponentCb = this.Component = null),
                          (this.pendingRemovals = 0),
                          (this.pendingRemovalCb = null),
                          this._isDynamicLiteral ? (this.transMode = this._checkParam("transition-mode")) : this.resolveComponent(this.expression, d.bind(this.initStatic, this)));
                },
                initStatic: function () {
                    var b,
                        a = this.anchor,
                ...
                setComponent: function (a, b) {
                    this.invalidatePending(),
                        a
                            ...
                            : (this.unbuild(!0), this.remove(this.childVM, b), this.unsetCurrent());
                },
                ...
                build: function (a) {
                    ...
                    if (b) return b;
                    if (this.Component) {
                        var c = { el: f.clone(this.el), template: this.template, _linkerCachable: !this.template, _asComponent: !0, _isRouterView: this._isRouterView, _context: this.vm };
                        a && d.extend(c, a);
        ...
        (function (a) {
            function g(b, c) {
                ...
                if (j) {
                    ...
                    return c.replace
                        ? (b === document.body && "production" !== a.env.NODE_ENV && d.warn("You are mounting an instance with a template to <body>. This will replace <body> entirely. You should probably use `replace: false` here."),
                ...
                "production" !== a.env.NODE_ENV && d.warn("Invalid template option: " + g);
            }
            function h(a) {
                if (1 === a.nodeType && a.hasAttributes()) return d.toArray(a.attributes);
            }
            function i(a, b) {
                for (var e, f, c = a.attributes, d = c.length; d--; ) (e = c[d].name), (f = c[d].value), b.hasAttribute(e) ? "class" === e && ((f = b.getAttribute(e) + " " + f), b.setAttribute(e, f)) : b.setAttribute(e, f);
            }
            var d = c(264),
                e = c(268),
                f = c(285);
            b.transclude = function (a, b) {
                return (
                    ...
                    b && (b._asComponent && !b.template && (b.template = "<content></content>"), b.template && ((b._content = d.extractContent(a)), (a = g(a, b)))),
                    a instanceof DocumentFragment && (d.prepend(d.createAnchor("v-start", !0), a), a.appendChild(d.createAnchor("v-end", !0))),
                    a
                );
            };
        }.call(b, c(162)));
    ...
    function (a, b) {
        ...
        a.exports = {
            ...
            objectHandler: function (a) {
                ...
                for (c in a) (d = a[c]), d !== b[c] && ((b[c] = d), this.setAttr(c, d));
            },
            setAttr: function (a, b) {
                e[a] && a in this.el
                    ? (this.valueRemoved || (this.el.removeAttribute(a), (this.valueRemoved = !0)), (this.el[a] = b))
                    : null != b && b !== !1
                    ? d.test(a)
    ...
    function (a, b, c) {
        ...
        (b.append = function (a, b, c, d) {
            ...
            (b.blockAppend = function (a, c, e) {
                for (var f = d.toArray(a.childNodes), g = 0, h = f.length; g < h; g++) b.before(f[g], c, e);
            }),
            (b.blockRemove = function (a, c, d) {
                for (var f, e = a.nextSibling; e !== c; ) (f = e.nextSibling), b.remove(e, d), (e = f);
            });
    ...
    function (a, b, c) {
        ...
        a.exports = {
            ...
            update: function (a) {
                this.arg ? (a ? e(this.el, this.arg) : f(this.el, this.arg)) : a && "string" == typeof a ? this.handleObject(g(a)) : d.isPlainObject(a) ? this.handleObject(a) : this.cleanup();
            },
            handleObject: function (a) {
                this.cleanup(a);
                for (var b = (this.prevKeys = Object.keys(a)), c = 0, d = b.length; c < d; c++) {
                    var g = b[c];
        ...
        (function (b) {
            ...
            a.exports = {
                ...
                bind: function () {
                    ...
                    return a ? void (a._refID = this.expression) : void ("production" !== b.env.NODE_ENV && d.warn("v-ref should only be used on a component root element."));
                },
            };
        }.call(b, c(162)));
    },
    ...
    function (a, b, c) {
        ...
        function l(a) {
            ...
            if ((i || (i = document.createElement("div")), b in i.style)) return a;
            for (var j, g = e.length; g--; ) if (((j = f[g] + c), j in i.style)) return e[g] + a;
        }
        var d = c(264),
            e = ["-webkit-", "-moz-", "-ms-"],
            f = ["Webkit", "Moz", "ms"],
        ...
        a.exports = {
            ...
            objectHandler: function (a) {
                ...
                for (c in a) (d = a[c]), d !== b[c] && ((b[c] = d), this.setProp(c, d));
            },
            setProp: function (a, b) {
                if ((a = k(a)))
                    if ((null != b && (b += ""), b)) {
                        var c = g.test(b) ? "important" : "";
                        c && (b = b.replace(g, "").trim()), this.el.style.setProperty(a, b, c);
    ...
    function (a, b, c) {
        ...
        (p.enter = function (a, b) {
            this.cancelPending(),
                ...
                this.entered || ((this.cancel = this.hooks && this.hooks.enterCancelled), e.push(this.enterNextTick));
        }),
            (p.enterNextTick = function () {
                ...
                this.pendingJsCb ? b === l && g(this.el, this.enterClass) : b === l ? (g(this.el, this.enterClass), this.setupCssCb(h, a)) : b === m ? this.setupCssCb(i, a) : a();
            }),
            (p.enterDone = function () {
                (this.entered = !0), (this.cancel = this.pendingJsCb = null), g(this.el, this.enterClass), this.callHook("afterEnter"), this.cb && this.cb();
            }),
            (p.leave = function (a, b) {
                this.cancelPending(),
                    ...
                    this.left || ((this.cancel = this.hooks && this.hooks.leaveCancelled), this.op && !this.pendingJsCb && (this.justEntered ? this.leaveDone() : e.push(this.leaveNextTick)));
            }),
            ...
            (p.leaveDone = function () {
                (this.left = !0), (this.cancel = this.pendingJsCb = null), this.op(), g(this.el, this.leaveClass), this.callHook("afterLeave"), this.cb && this.cb(), (this.op = null);
            }),
            (p.cancelPending = function () {
                this.op = this.cb = null;
                var a = !1;
                this.pendingCssCb && ((a = !0), d.off(this.el, this.pendingCssEvent, this.pendingCssCb), (this.pendingCssEvent = this.pendingCssCb = null)),
                    this.pendingJsCb && ((a = !0), this.pendingJsCb.cancel(), (this.pendingJsCb = null)),
                    a && (g(this.el, this.enterClass), g(this.el, this.leaveClass)),
            ...
            (p.callHookWithCb = function (a) {
                ...
                b && (b.length > 1 && (this.pendingJsCb = d.cancellable(this[a + "Done"])), b.call(this.vm, this.el, this.pendingJsCb));
            }),
            (p.getCssTransitionType = function (a) {
                if (!(!h || document.hidden || (this.hooks && this.hooks.css === !1) || q(this.el))) {
            ...
            (p.setupCssCb = function (a, b) {
                ...
                var c = this,
                    ...
                    f = (this.pendingCssCb = function (g) {
                        g.target === e && (d.off(e, a, f), (c.pendingCssEvent = c.pendingCssCb = null), !c.pendingJsCb && b && b());
                    });
                d.on(e, a, f);
            }),
            (a.exports = o);
    ...
    function (a, b, c) {
        function g() {
            for (var a = document.documentElement.offsetHeight, b = 0; b < e.length; b++) e[b]();
            return (e = []), (f = !1), a;
        }
        var d = c(264),
            e = [],
    ...
    function (a, b, c) {
        (function (b) {
            ...
            a.exports = {
                ...
                update: function (a) {
                    if ("function" != typeof a) return void ("production" !== b.env.NODE_ENV && d.warn('Directive v-on="' + this.arg + ": " + this.expression + '" expects a function value, got ' + a));
                    this.reset();
                    var c = this.vm;
    ...
    function (a, b, c) {
        (function (b) {
            var d = c(264),
                e = { text: c(304), radio: c(305), select: c(306), checkbox: c(307) };
            a.exports = {
                priority: 800,
                twoWay: !0,
                handlers: e,
                bind: function () {
                    this.checkFilters(),
                        this.hasRead && !this.hasWrite && "production" !== b.env.NODE_ENV && d.warn("It seems you are using a read-only filter with v-model. You might want to use a two-way filter to ensure correct behavior.");
                    var f,
                        a = this.el,
                        c = a.tagName;
                    if ("INPUT" === c) f = e[a.type] || e.text;
                        ...
                        if ("TEXTAREA" !== c) return void ("production" !== b.env.NODE_ENV && d.warn("v-model does not support element type: " + c));
                        f = e.text;
                    }
                    (a.__v_model = this), f.bind.call(this), (this.update = f.update), (this._unbind = f.unbind);
                },
        ...
        a.exports = {
            bind: function () {
                ...
                d.isAndroid ||
                    ...
                    this.hasjQuery ? (jQuery(b).on("change", this.listener), e || jQuery(b).on("input", this.listener)) : (this.on("change", this.listener), e || this.on("input", this.listener)),
                    !e &&
                        d.isIE9 &&
    ...
    function (a, b, c) {
        (function (b) {
                ...
                function k(a) {
                    if (d.isArray(a)) {
                        for (var e = g.options.length; e--; ) {
                            ...
                            if (f !== i) {
                                var j = f.parentNode;
                                j === g ? j.removeChild(f) : (g.removeChild(j), (e = g.options.length));
                            }
                        }
                        h(g, a), c.forceUpdate();
                    } else "production" !== b.env.NODE_ENV && d.warn("Invalid options value for v-model: " + a);
                }
                var c = this,
                    g = c.el,
                    i = (c.defaultOption = c.el.options[0]),
                    j = f.parse(a)[0];
                (this.optionWatcher = new e(this.vm, j.expression, k, { deep: !0, filters: j.filters })), k(this.optionWatcher.value);
            }
            function h(a, b) {
                for (var c, e, f = 0, g = b.length; f < g; f++)
                    (c = b[f]),
                        c.options
                            ? ((e = document.createElement("optgroup")), (e.label = c.label), h(e, c.options))
                            : ((e = document.createElement("option")),
                              "string" == typeof c || "number" == typeof c
                                  ? (e.text = e.value = c)
                                  : (null == c.value || d.isObject(c.value) || (e.value = c.value), (e._value = c.value), (e.text = c.text || ""), c.disabled && (e.disabled = !0))),
                        a.appendChild(e);
            }
            function i() {
                for (var a, b = this.el.options, c = 0, e = b.length; c < e; c++) b[c].hasAttribute("selected") && (this.multiple ? (a || (a = [])).push(b[c].value) : (a = b[c].value));
                "undefined" != typeof a && (this._initValue = this.number ? d.toNumber(a) : a);
            }
            function j(a, b) {
                for (var d, e, c = b ? [] : null, f = 0, g = a.options.length; f < g; f++)
            ...
            function k(a, b) {
                for (var c = a.length; c--; ) if (d.looseEqual(a[c], b)) return c;
                return -1;
            }
            var d = c(264),
                e = c(280),
            ...
            a.exports = {
                bind: function () {
                    ...
                    c && g.call(this, c),
                        ...
                        this.on("change", function () {
                            ...
                            (c = a.number ? (d.isArray(c) ? c.map(d.toNumber) : d.toNumber(c)) : c), a.set(c);
                        }),
                        i.call(this),
                ...
                update: function (a) {
                    ...
                    for (var g, h, c = this.multiple && d.isArray(a), e = b.options, f = e.length; f--; ) (g = e[f]), (h = g.hasOwnProperty("_value") ? g._value : g.value), (g.selected = c ? k(a, h) > -1 : d.looseEqual(a, h));
                },
                unbind: function () {
    ...
    function (a, b, c) {
        ...
        a.exports = {
            bind: function () {
                function f() {
                    var d = b.checked;
                    return d && null !== c && (d = a.vm.$eval(c)), d || null === e || (d = a.vm.$eval(e)), d;
                }
                var a = this,
                    b = this.el,
    ...
    function (a, b, c) {
        (function (b) {
            function q(a, b, c) {
                ...
                if (d) {
                    for (; (!d.__vue__ || d.__vue__.$options._repeatId !== c) && d !== b; ) d = d.previousSibling;
                    return d.__vue__;
                }
            }
            function r(a) {
            ...
            function s(a) {
                for (var b = {}, c = 0, d = a.length; c < d; c++) b[a[c].$key] = a[c];
                return b;
            }
            function t(a) {
                var b = typeof a;
            ...
            a.exports = {
                bind: function () {
                    "production" !== b.env.NODE_ENV &&
                        ...
                        d.warn("Don't use v-repeat for v-model options; use the `options` param instead: http://vuejs.org/guide/forms.html#Dynamic_Select_Options");
                    ...
                    a && ((this.arg = a[1]), (this._watcherExp = a[2])),
                        ...
                        (this.template = d.isTemplate(this.el) ? j.parse(this.el, !0) : this.el),
                        (this.idKey = this._checkParam("track-by"));
                    var c = +this._checkParam("stagger");
                    (this.enterStagger = +this._checkParam("enter-stagger") || c),
                        (this.leaveStagger = +this._checkParam("leave-stagger") || c),
                        (this.refID = this._checkParam(e.prefix + "ref")),
                ...
                checkIf: function () {
                    null !== d.attr(this.el, "if") && "production" !== b.env.NODE_ENV && d.warn('Don\'t use v-if with v-repeat. Use v-show or the "filterBy" filter instead.');
                },
                checkComponent: function () {
                    ...
                    if (b) {
                        (this.Component = null), (this.asComponent = !0), null !== this._checkParam("inline-template") && (this.inlineTemplate = d.extractContent(this.el, !0));
                        var e = h.parse(b);
                        if (e) {
                        ...
                        (this.Component = d.Vue), (this.inline = !0), (this.template = k.transclude(this.template));
                        var c = d.extend({}, a);
                        (c._asComponent = !1), (this._linkFn = k.compile(this.template, c));
                    }
                },
                resolveComponent: function () {
                    (this.componentState = n),
                        this.vm._resolveComponent(
                            this.componentId,
                            d.bind(function (a) {
                                this.componentState !== p && ((this.Component = a), (this.componentState = o), this.realUpdate(this.pendingData), (this.pendingData = null));
                            }, this)
                        );
                },
                resolveDynamicComponent: function (a, c) {
                    ...
                    return (
                        "production" !== b.env.NODE_ENV && d.assertAsset(h, "component", g),
                        h.options ? h : ("production" !== b.env.NODE_ENV && d.warn("Async resolution is not supported for v-repeat + dynamic component. (component: " + g + ")"), d.Vue)
                    );
                },
                update: function (a) {
                    if (("production" === b.env.NODE_ENV || d.isArray(a) || d.warn("v-repeat pre-converts Objects into Arrays, and v-repeat filters should always return Arrays."), this.componentId)) {
                        var c = this.componentState;
                        c === m ? ((this.pendingData = a), this.resolveComponent()) : c === n ? (this.pendingData = a) : c === o && this.realUpdate(a);
                ...
                diff: function (a, c) {
                    ...
                    for (r = 0, s = a.length; r < s; r++)
                        (n = a[r]),
                            ...
                            p
                                ? ("production" !== b.env.NODE_ENV && p._reused && d.warn('Duplicate objects found in v-repeat="' + this.expression + '": ' + JSON.stringify(o)),
                                  (p._reused = !0),
                                  (p.$index = r),
                                  (e || g || t) && (k ? (p[k] = o) : d.isPlainObject(o) ? (p.$data = o) : (p.$value = o)))
                                : ((p = this.build(n, r, !0)), (p._reused = !1)),
                            (m[r] = p),
                            l && p.$before(i);
                    if (l) return m;
                    var u = 0,
                        v = c.length - m.length;
                    for (r = 0, s = c.length; r < s; r++) (p = c[r]), p._reused || (this.uncacheVm(p), p.$destroy(!1, !0), this.remove(p, u++, v, j));
                    var w,
                        x,
                        y,
                        z = 0;
                    for (r = 0, s = m.length; r < s; r++)
                        (p = m[r]),
                            (w = m[r - 1]),
                            (x = w ? (w._staggerCb ? w._staggerAnchor : w._fragmentEnd || w.$el) : h),
                            p._reused && !p._staggerCb ? ((y = q(p, h, this.id)), y !== w && this.move(p, x)) : this.insert(p, z++, x, j),
                            (p._reused = !1);
                    return m;
                },
                build: function (a, c, e) {
                    ...
                    var h = this.converted ? a.$value : a,
                        i = this.arg;
                    i ? ((a = {}), (a[i] = h)) : g(h) ? (a = h) : ((a = {}), (f.$value = h));
                    var k = this.Component || this.resolveDynamicComponent(a, f),
                        ...
                        m = l.$addChild(
                            {
                                ...
                                _linkerCachable: !this.inlineTemplate && k !== d.Vue,
                            ...
                            m.$watch(i || "$value", function (a) {
                                n.filters &&
                                    ...
                                    n._withLock(function () {
                                        n.converted ? (n.rawValue[m.$key] = a) : n.rawValue.$set(m.$index, a);
                                    });
                            }),
                        m
                    );
                ...
                unbind: function () {
                    if (((this.componentState = p), this.refID && (this.vm.$[this.refID] = null), this.vms)) for (var b, a = this.vms.length; a--; ) (b = this.vms[a]), this.uncacheVm(b), b.$destroy();
                },
                cacheVm: function (a, c, e, g) {
                    var k,
                        ...
                        j = !f(a);
                    g || h || j
                        ? ((k = h ? ("$index" === h ? e : a[h]) : g || e), i[k] ? j || "$index" === h || ("production" !== b.env.NODE_ENV && d.warn("Duplicate objects with the same track-by key in v-repeat: " + k)) : (i[k] = c))
                        : ((k = this.id),
                          a.hasOwnProperty(k) ? (null === a[k] ? (a[k] = c) : "production" !== b.env.NODE_ENV && d.warn('Duplicate objects found in v-repeat="' + this.expression + '": ' + JSON.stringify(a))) : d.define(a, k, c)),
                        (c._raw = a);
                },
                ...
                insert: function (a, b, c, e) {
                    ...
                    if (e && f) {
                        ...
                        g || ((g = a._staggerAnchor = d.createAnchor("stagger-anchor")), (g.__vue__ = a)), d.after(g, c);
                ...
                _preProcess: function (a) {
                    ...
                    if (g(a)) {
                        for (var h, c = Object.keys(a), e = c.length, f = new Array(e); e--; ) (h = c[e]), (f[e] = { $key: h, $value: a[h] });
                        return (this.converted = !0), f;
                    }
                    return (this.converted = !1), "number" === b ? (a = r(a)) : "string" === b && (a = d.toArray(a)), a || [];
                },
            };
        }.call(b, c(162)));
    },
    function (a, b, c) {
        (function (b) {
            ...
            a.exports = {
                bind: function () {
                    var a = this.el;
                    if (a.__vue__) "production" !== b.env.NODE_ENV && d.warn('v-if="' + this.expression + '" cannot be used on an instance root element.'), (this.invalid = !0);
                    else {
                        (this.start = d.createAnchor("v-if-start")),
                            (this.end = d.createAnchor("v-if-end")),
                            d.replace(a, this.end),
                            d.before(this.start, this.end),
                            d.isTemplate(a) ? (this.template = f.parse(a, !0)) : ((this.template = document.createDocumentFragment()), this.template.appendChild(f.clone(a)));
                        var c = (this.vm.constructor.cid || "") + a.outerHTML;
                        (this.linker = i.get(c)), this.linker || ((this.linker = e.compile(this.template, this.vm.$options, !0)), i.put(c, this.linker));
                    }
                },
                update: function (a) {
                    this.invalid || (a ? this.unlink || this.link(f.clone(this.template), this.linker) : this.teardown());
                },
                link: function (a, b) {
                    var c = this.vm;
                    if (((this.unlink = b(c, a, this._host)), g.blockAppend(a, this.end, c), d.inDoc(c.$el))) {
                ...
                teardown: function () {
                    if (this.unlink) {
                        var a;
                        d.inDoc(this.vm.$el) && (a = this.getContainedComponents()), g.blockRemove(this.start, this.end, this.vm), a && a.forEach(k), this.unlink(), (this.unlink = null);
                    }
                },
                getContainedComponents: function () {
                    function d(a) {
                        for (var e, d = b; e !== c; ) {
                            if (((e = d.nextSibling), d === a.$el || (d.contains && d.contains(a.$el)))) return !0;
                            d = e;
                        }
                        return !1;
                    }
    ...
    function (a, b, c) {
        function f(a, b, c) {
            for (var d = document.createDocumentFragment(), f = 0, g = a.length; f < g; f++) {
                var h = a[f];
                c && !h.__v_selected ? d.appendChild(e(h)) : c || h.parentNode !== b || ((h.__v_selected = !0), d.appendChild(e(h)));
            }
            return d;
        }
        var d = c(264),
        ...
        a.exports = {
            bind: function () {
                ...
                if (g) {
                    ...
                    j.length ? ((d = f(j, c)), d.hasChildNodes() ? this.compile(d, e, a) : this.fallback()) : this.fallback();
                } else {
                    var h = this,
                        i = function () {
            ...
            compile: function (a, b, c) {
                a && b && (this.unlink = b.$compile(a, c)), a ? d.replace(this.el, a) : d.remove(this.el);
            },
            unbind: function () {
                this.unlink && this.unlink();
            },
        ...
        (function (b) {
            ...
            a.exports = {
                ...
                insert: function (a) {
                    ...
                    if (("production" !== b.env.NODE_ENV && d.assertAsset(c, "partial", a), c)) {
                        var f = e.parse(c, !0),
    ...
    function (a, b, c) {
        ...
        var f = { esc: 27, tab: 9, enter: 13, space: 32, delete: 46, up: 38, left: 37, right: 39, down: 40 };
        (b.key = function (a, b) {
            if (a) {
                var c = f[b];
                return (
            ...
            (b.orderBy = function (a, b, c) {
                ...
                return (
                    ...
                    a.slice().sort(function (a, c) {
                        return (
                            "$key" !== b && "$value" !== b && (a && "$value" in a && (a = a.$value), c && "$value" in c && (c = c.$value)),
        ...
        (function (a) {
            function f(a, b, c) {
                if (c) {
                    var e, f, h, i;
                    for (f in c)
                        if (((e = c[f]), d.isArray(e))) for (h = 0, i = e.length; h < i; h++) g(a, b, f, e[h]);
                        else g(a, b, f, e);
                }
            }
            function g(b, c, e, f, h) {
                ...
                if ("function" === i) b[c](e, f, h);
                    ...
                    var j = b.$options.methods,
                        k = j && j[f];
                    k ? b[c](e, k, h) : "production" !== a.env.NODE_ENV && d.warn('Unknown method: "' + f + '" when registering callback for ' + c + ': "' + e + '".');
            ...
            function j() {
                this._isAttached && ((this._isAttached = !1), this.$children.forEach(k));
            }
            function k(a) {
            ...
            (b._initEvents = function () {
                ...
                (b._callHook = function (a) {
                    ...
                    if (b) for (var c = 0, d = b.length; c < d; c++) b[c].call(this);
                    this.$emit("hook:" + a);
                });
        }.call(b, c(162)));
    },
    function (a, b, c) {
        (function (a) {
            ...
            function j(a, b) {
                ...
                return function () {
                    return c.dirty && c.evaluate(), g.target && c.depend(), c.value;
                };
            }
            var d = c(264),
                e = c(273),
            ...
            (b._initScope = function () {
                ...
                (b._initProps = function () {
                    var b = this.$options,
                        c = b.el,
                        f = b.props;
                    f && !c && "production" !== a.env.NODE_ENV && d.warn("Props will not be compiled if no `el` option is provided at instantiation."),
                        (c = b.el = d.query(c)),
                        (this._propsUnlinkFn = c && 1 === c.nodeType && f ? e.compileAndLinkProps(this, c, f) : null);
                }),
                (b._initData = function () {
                    ...
                    if (c) {
                        this._data = c;
                        for (var e in a) (null === this._props[e].raw && c.hasOwnProperty(e)) || c.$set(e, a[e]);
                    }
                    var i,
                        j,
                        g = this._data,
                        h = Object.keys(g);
                    for (i = h.length; i--; ) (j = h[i]), d.isReserved(j) || this._proxy(j);
                    f.create(g, this);
                }),
                (b._setData = function (a) {
                    ...
                    if (h) for (g = h.length; g--; ) (e = h[g].name), "$data" === e || a.hasOwnProperty(e) || a.$set(e, b[e]);
                    for (c = Object.keys(b), g = c.length; g--; ) (e = c[g]), d.isReserved(e) || e in a || this._unproxy(e);
                    for (c = Object.keys(a), g = c.length; g--; ) (e = c[g]), this.hasOwnProperty(e) || d.isReserved(e) || this._proxy(e);
                ...
                (b._initComputed = function () {
                    ...
                    if (a)
                        for (var b in a) {
                            ...
                            "function" == typeof c ? ((e.get = j(c, this)), (e.set = i)) : ((e.get = c.get ? (c.cache !== !1 ? j(c.get, this) : d.bind(c.get, this)) : i), (e.set = c.set ? d.bind(c.set, this) : i)),
    ...
    function (a, b, c) {
        function i(a) {
            if (((this.value = a), (this.dep = new f()), d.define(a, "__ob__", this), d.isArray(a))) {
        ...
        c(320),
            (i.create = function (a, b) {
                var c;
                return a && a.hasOwnProperty("__ob__") && a.__ob__ instanceof i ? (c = a.__ob__) : (!d.isArray(a) && !d.isPlainObject(a)) || Object.isFrozen(a) || a._isVue || (c = new i(a)), c && b && c.addVm(b), c;
            }),
    ...
    function (a, b, c) {
        ...
        ["push", "pop", "shift", "unshift", "splice", "sort", "reverse"].forEach(function (a) {
            ...
            d.define(f, a, function () {
                for (var d = arguments.length, e = new Array(d); d--; ) e[d] = arguments[d];
                var h,
                    i,
                    f = b.apply(this, e),
                    g = this.__ob__;
                ...
                return h && g.observeArray(h), i && g.unobserveArray(i), g.notify(), f;
            });
        }),
            d.define(e, "$set", function (b, c) {
                return b >= this.length && (this.length = b + 1), this.splice(b, 1, c)[0];
            }),
            d.define(e, "$remove", function (b) {
                if (this.length) return "number" != typeof b && (b = d.indexOf(this, b)), b > -1 ? this.splice(b, 1) : void 0;
            }),
            (a.exports = f);
    },
    function (a, b, c) {
        ...
        (b._compile = function (a) {
            ...
            if (b._linkFn) this._initElement(a), (this._unlinkFn = b._linkFn(this, a, c));
                ...
                var h,
                    g = f.compileRoot(a, b),
                    i = this.constructor;
                b._linkerCachable && ((h = i.linker), h || (h = i.linker = f.compile(a, b)));
                var j = g(this, a),
    ...
    function (a, b, c) {
        (function (b) {
            ...
            (j.prototype._bind = function (a) {
                if (
                    (("cloak" !== this.name || this.vm._isCompiled) && this.el && this.el.removeAttribute && this.el.removeAttribute(e.prefix + this.name),
                    "function" == typeof a ? (this.update = a) : d.extend(this, a),
                    (this._watcherExp = this.expression),
                    this._checkDynamicLiteral(),
                    this.bind && this.bind(),
                    this._watcherExp && (this.update || this.twoWay) && (!this.isLiteral || this._isDynamicLiteral) && !this._checkStatement())
                ) {
                    var b = this;
                    this.update
                        ...
                        : (this._update = i);
                    var c = this._preProcess ? d.bind(this._preProcess, this) : null,
                        g = (this._watcher = new f(this.vm, this._watcherExp, this._update, { filters: this.filters, twoWay: this.twoWay, deep: this.deep, preProcess: c }));
                    null != this._initValue ? g.set(this._initValue) : this.update && this.update(g.value);
                }
                this._bound = !0;
            }),
                ...
                (j.prototype.set = function (a) {
                    this.twoWay
                        ...
                        : "production" !== b.env.NODE_ENV && d.warn("Directive.set() can only be used inside twoWaydirectives.");
                }),
                ...
                (j.prototype.on = function (a, b) {
                    d.on(this.el, a, b), (this._listeners || (this._listeners = [])).push([a, b]);
                }),
                (j.prototype._teardown = function () {
                    if (this._bound) {
                        (this._bound = !1), this.unbind && this.unbind(), this._watcher && this._watcher.teardown();
                        var a = this._listeners;
                        if (a) for (var b = 0; b < a.length; b++) d.off(this.el, a[b][0], a[b][1]);
        ...
        (function (a) {
            ...
            (b._applyFilters = function (b, c, e, f) {
                ...
                for (l = 0, m = e.length; l < m; l++)
                    if (((g = e[l]), (h = d.resolveAsset(this.$options, "filters", g.name)), "production" !== a.env.NODE_ENV && d.assertAsset(h, "filter", g.name), h && ((h = f ? h.write : h.read || h), "function" == typeof h))) {
                        if (((i = f ? [b, c] : [b]), (k = f ? 2 : 1), g.args)) for (n = 0, o = g.args.length; n < o; n++) (j = g.args[n]), (i[n + k] = j.dynamic ? this.$get(j.value) : j.value);
                        b = h.apply(this, i);
                    }
                return b;
            }),
                (b._resolveComponent = function (b, c) {
                    ...
                    if (("production" !== a.env.NODE_ENV && d.assertAsset(e, "component", b), e))
                        if (e.options) c(e);
                            ...
                            e(
                                function (b) {
                                    d.isPlainObject(b) && (b = d.Vue.extend(b)), (e.resolved = b);
                                    for (var c = 0, g = f.length; c < g; c++) f[c](b);
                                },
                                function (e) {
                                    "production" !== a.env.NODE_ENV && d.warn("Failed to resolve async component: " + b + ". " + (e ? "\nReason: " + e : ""));
                                }
                            );
                        }
                });
    ...
    function (a, b, c) {
        ...
        (b.$get = function (a) {
            ...
            (b.$watch = function (a, b, c) {
                var f,
                    e = this;
                "string" == typeof a && ((f = g.parse(a)[0]), (a = f.expression));
                var h = new d(e, a, b, { deep: c && c.deep, user: !c || c.user !== !1, filters: f && f.filters });
                return (
    ...
    function (a, b, c) {
        function f(a, b, c, e, f, i) {
            ...
            return a._isFragment ? g(a, b, k, c) : k(a.$el, b, a, c), l && a._callHook("attached"), a;
        }
        function g(a, b, c, d) {
            for (var g, e = a._fragmentStart, f = a._fragmentEnd; g !== f; ) (g = e.nextSibling), c(e, b, a), (e = g);
            c(f, b, a, d);
        }
        function h(a) {
        ...
        (b.$nextTick = function (a) {
            ...
            (b.$prependTo = function (a, b, c) {
                return (a = h(a)), a.hasChildNodes() ? this.$before(a.firstChild, b, c) : this.$appendTo(a, b, c), this;
            }),
            (b.$before = function (a, b, c) {
                return f(this, a, b, c, j, e.before);
            }),
            (b.$after = function (a, b, c) {
                return (a = h(a)), a.nextSibling ? this.$before(a.nextSibling, b, c) : this.$appendTo(a.parentNode, b, c), this;
            }),
            (b.$remove = function (a, b) {
                ...
                return this._isFragment && !this._blockFragment.hasChildNodes() ? ((f = b === !1 ? i : e.removeThenAppend), g(this, this._blockFragment, f, j)) : (f = b === !1 ? k : e.remove)(this.$el, this, j), this;
            });
    },
    function (a, b, c) {
        function f(a, b, c) {
            var d = a.$parent;
            if (d && c && !e.test(b)) for (; d; ) (d._eventsCount[b] = (d._eventsCount[b] || 0) + c), (d = d.$parent);
        }
        var d = c(264);
        (b.$on = function (a, b) {
            return (this._events[a] || (this._events[a] = [])).push(b), f(this, a, 1), this;
        }),
            (b.$once = function (a, b) {
                function d() {
            ...
            (b.$off = function (a, b) {
                var c;
                if (!arguments.length) {
                    if (this.$parent) for (a in this._events) (c = this._events[a]), c && f(this, a, -c.length);
                    return (this._events = {}), this;
                }
                if (((c = this._events[a]), !c)) return this;
                if (1 === arguments.length) return f(this, a, -c.length), (this._events[a] = null), this;
            ...
            (b.$emit = function (a) {
                ...
                if (b) {
                    for (var c = arguments.length - 1, e = new Array(c); c--; ) e[c] = arguments[c + 1];
                    (c = 0), (b = b.length > 1 ? d.toArray(b) : b);
                    for (var f = b.length; c < f; c++) b[c].apply(this, e) === !1 && (this._eventCancelled = !0);
                }
                return this;
            }),
        ...
        (function (a) {
            ...
            (b.$mount = function (b) {
                return this._isCompiled
                    ? void ("production" !== a.env.NODE_ENV && d.warn("$mount() should be called only once."))
                    : ((b = d.query(b)),
                      ...
                      this._initDOMHooks(),
                      d.inDoc(this.$el) ? (this._callHook("attached"), f.call(this)) : this.$once("hook:attached", f),
                      this);
            }),
    ...
    function (a, b, c) {
        ...
        d.component("fk-bubble-action", {
            props: ["label", "icon", "title", { name: "click", type: Function, required: !0 }],
            template:
            ...
            methods: {
                handleClick: function (b) {
                    this.$parent.restoreSelection(),
                        this.button.type ? this.$parent.expand(this.button) : this.button.command ? this.$parent.executeCommand(this.button) : console.warn("%s button is missing a command property", this.button.title),
                        b.preventDefault();
                },
            },
            template:
    ...
    function (a, b, c) {
        ...
        d.component("link-prompt", {
            ...
            methods: {
                confirm: function () {
                    this.$parent.executeCommand(this.button, this.$$.input.value);
                },
                shortcut: function (b) {
                    return 8 !== b.keyCode || this.$$.input.value.length ? void ((b.metaKey || b.ctrlKey) && "K" === String.fromCharCode(b.keyCode) && this.close()) : (b.preventDefault(), this.remove());
                },
                close: function () {
    ...
    function (a, b) {
        ...
        function c(a) {
            ...
            if (a instanceof HTMLElement) {
                for (var d in b) b[d] = parseInt(window.getComputedStyle(a, null).getPropertyValue(d).replace(/px/g, "").split(/\s/));
                (c = a.getBoundingClientRect()), (a.style.overflow = "hidden");
            }
            var e = a.getBoundingClientRect();
            return (
                a instanceof HTMLElement && (e.left !== c.left && (b["padding-left"] = 0), a.style.removeProperty("overflow"), a.style.length || (a.getAttribute("style"), a.removeAttribute("style"))),
                { top: e.top + window.pageYOffset + b["padding-top"], bottom: e.bottom + window.pageYOffset, left: e.left + window.pageXOffset + b["padding-left"], right: e.right + window.pageXOffset, height: e.height, width: e.width }
            );
        }
        a.exports = c;
    },
    ...
    function (a, b, c) {
        ...
        g.push({
            ...
            g.push({
                ...
                icon: "blockquote",
                isActive: function (b) {
                    return "BLOCKQUOTE" === b.context.closestElementWithRules.tagName;
                },
                command: function (b) {
            ...
            g.push({
                ...
                command: function (b, c) {
                    if ((b.commands.execute("unlink"), "string" == typeof c && c.length)) return c.match("^(http|https)://") || (c = "http://" + c), b.commands.execute("link", c);
                },
                onCollapse: function (b, c) {
                    return "string" == typeof c && "" === c ? b.commands.execute("unlink") : void [].forEach.call(document.querySelectorAll(".fk-selected-link"), e.default);
                },
            }),
            g.push({
                name: "formatUl",
                ...
                isVisible: function (b) {
                    ...
                    return "UL" === c || "OL" === c || b.ancestorElement.classList.contains("checklist");
                },
                isActive: function (b) {
            ...
            g.push({
                ...
                isVisible: function (b) {
                    ...
                    return b.ancestorElement.querySelector(".checklist__item--checked:not(.checklist__item--hide)");
                },
                isActive: function (b) {
                    return !1;
                },
    ...
    function (a, b, c) {
        ...
        (g.prototype.init = function (a) {
            (this.editor = a),
                (this.nightMode = document.body.querySelector(".fk-icon-nightmode")),
                (this.info = document.body.querySelector(".fk-icon-info")),
                (this.showMode = document.body.querySelector(".fk-icon-hide")),
                chrome &&
                    chrome.runtime.getManifest &&
                    ((this.manifest = chrome.runtime.getManifest()),
                    (this.version = parseInt(this.manifest.version.replace(/\./g, ""))),
                    this.editor.on("history.checkpoint", this.sync.bind(this)),
                    chrome.storage.sync.get("mindfulC", this.loadInitialContent.bind(this)),
                    chrome.storage.onChanged.addListener(this.updateTab.bind(this)),
            ...
            (g.prototype.createUpdateBackup = function (a) {
                ...
                localStorage.getItem(b) || (console.log("Created local backup for update", this.version), localStorage.setItem(b, a));
            }),
            (g.prototype.loadInitialContent = function (a) {
                if (a.mindfulC) {
                    var b = e.default.decompressFromUTF16(a.mindfulC);
                    this.createUpdateBackup(b), localStorage.setItem("newVersion", "true"), (this.editor.el.innerHTML = b);
                } else console.log("mindfulC not found!"), localStorage.getItem("newVersion") || this.createNonCompressedBackup();
            }),
            (g.prototype.createNonCompressedBackup = function () {
                var a = this;
                localStorage.getItem("backup") ||
                    chrome.storage.sync.get("mindful", function (b) {
                        console.log("Setting editor to old model for the last time…");
                        var c = b.mindful;
                        c && (localStorage.setItem("backup", c), (a.editor.el.innerHTML = c), a.sync());
                    });
            }),
            (g.prototype.updateTab = function (a, b) {
                if ((a.mindful && document.hidden && (localStorage.setItem("mindful", content), (this.editor.el.innerHTML = a.mindful.newValue)), a.mindfulC && document.hidden)) {
                    var c = e.default.decompressFromUTF16(a.mindfulC.newValue);
                    (this.editor.el.innerHTML = c), this.editor.selection.restoreSelection(), this.editor.selection.update(), this.editor.selection.collapse(!1);
                }
            }),
            (g.prototype.sync = function (a) {
                var b = this,
                    c = e.default.compressToUTF16(this.editor.el.innerHTML);
                chrome.storage.sync.set({ mindfulC: c, v: this.version }, function () {
            ...
            (g.prototype.faultyUpdateContentRollBackOptionNotification = function () {
                var a = this;
                setTimeout(function () {
            ...
            (g.prototype.initAnchorBehavior = function () {
                ...
                this.editor.on("mousemove", function (b) {
                    a.isFocused && document.documentElement.classList.remove("focus"), (a.isFocused = !1);
                }),
                    this.editor.on("blur", function (a) {
                        document.documentElement.classList.remove("metakey");
                    }),
                    this.editor.on("keydown", function (c) {
                        (b = c.metaKey || c.ctrlKey), b && document.documentElement.classList.add("metakey"), a.isFocused || document.documentElement.classList.add("focus"), (a.isFocused = !0);
                    }),
                    this.editor.on("click", function (a) {
                        (a.metaKey || a.ctrlKey) && a.target.closest("a") && window.open(a.target.closest("a").getAttribute("href"), "_blank");
                    }),
                    this.editor.on("keyup", function (a) {
                        b && document.documentElement.classList.remove("metakey"), (b = !1);
                    });
            }),
            (g.prototype.setNightMode = function () {
                document.documentElement.classList.remove("night", "day"), document.documentElement.classList.add(localStorage.getItem("daymode") || "day");
            }),
            (g.prototype.setHideMode = function () {
                document.documentElement.classList.remove("hide", "show"), document.documentElement.classList.add(localStorage.getItem("hidemode") || "show");
            }),
            (g.prototype.bindNightDayModeListeners = function () {
                var a = this;
                this.nightMode.addEventListener("click", function () {
                    localStorage.setItem("daymode", document.documentElement.classList.contains("night") ? "day" : "night"), a.setNightMode();
                }),
                    this.showMode.addEventListener("click", function () {
                        localStorage.setItem("hidemode", document.documentElement.classList.contains("show") ? "hide" : "show"), a.setHideMode();
                    });
            }),
            (a.exports = g);
    },
        ...
        var d,
            e = (function () {
                function e(a, b) {
                    if (!d[a]) {
                        d[a] = {};
                        for (var c = 0; c < a.length; c++) d[a][a.charAt(c)] = c;
                    }
                    return d[a][b];
                }
                var a = String.fromCharCode,
                    ...
                    f = {
                        ...
                        compressToUint8Array: function (a) {
                            for (var b = f.compress(a), c = new Uint8Array(2 * b.length), d = 0, e = b.length; d < e; d++) {
                        ...
                        decompressFromUint8Array: function (b) {
                            if (null === b || void 0 === b) return f.decompress(b);
                            for (var c = new Array(b.length / 2), d = 0, e = c.length; d < e; d++) c[d] = 256 * b[2 * d] + b[2 * d + 1];
                            var g = [];
                            return (
                        ...
                        _compress: function (a, b, c) {
                            ...
                            for (q = 0; q < a.length; q += 1)
                                if (((h = a.charAt(q)), Object.prototype.hasOwnProperty.call(f, h) || ((f[h] = l++), (g[h] = !0)), (i = j + h), Object.prototype.hasOwnProperty.call(f, i))) j = i;
                                else {
                                    if (Object.prototype.hasOwnProperty.call(g, j)) {
                                        if (j.charCodeAt(0) < 256) {
                                            for (d = 0; d < m; d++) (o <<= 1), p == b - 1 ? ((p = 0), n.push(c(o)), (o = 0)) : p++;
                                            for (e = j.charCodeAt(0), d = 0; d < 8; d++) (o = (o << 1) | (1 & e)), p == b - 1 ? ((p = 0), n.push(c(o)), (o = 0)) : p++, (e >>= 1);
                                        } else {
                                            for (e = 1, d = 0; d < m; d++) (o = (o << 1) | e), p == b - 1 ? ((p = 0), n.push(c(o)), (o = 0)) : p++, (e = 0);
                                            for (e = j.charCodeAt(0), d = 0; d < 16; d++) (o = (o << 1) | (1 & e)), p == b - 1 ? ((p = 0), n.push(c(o)), (o = 0)) : p++, (e >>= 1);
                                        }
                                        k--, 0 == k && ((k = Math.pow(2, m)), m++), delete g[j];
                                    } else for (e = f[j], d = 0; d < m; d++) (o = (o << 1) | (1 & e)), p == b - 1 ? ((p = 0), n.push(c(o)), (o = 0)) : p++, (e >>= 1);
                            ...
                            for (e = 2, d = 0; d < m; d++) (o = (o << 1) | (1 & e)), p == b - 1 ? ((p = 0), n.push(c(o)), (o = 0)) : p++, (e >>= 1);
                            for (;;) {
                                if (((o <<= 1), p == b - 1)) {
                                    n.push(c(o));
                                    break;
                        ...
                        _decompress: function (b, c, d) {
                            ...
                            for (n = 0, p = Math.pow(2, 2), q = 1; q != p; ) (o = s.val & s.position), (s.position >>= 1), 0 == s.position && ((s.position = c), (s.val = d(s.index++))), (n |= (o > 0 ? 1 : 0) * q), (q <<= 1);
                            switch ((f = n)) {
                                case 0:
                                    for (n = 0, p = Math.pow(2, 8), q = 1; q != p; ) (o = s.val & s.position), (s.position >>= 1), 0 == s.position && ((s.position = c), (s.val = d(s.index++))), (n |= (o > 0 ? 1 : 0) * q), (q <<= 1);
                                    r = a(n);
                                    break;
                                case 1:
                                    for (n = 0, p = Math.pow(2, 16), q = 1; q != p; ) (o = s.val & s.position), (s.position >>= 1), 0 == s.position && ((s.position = c), (s.val = d(s.index++))), (n |= (o > 0 ? 1 : 0) * q), (q <<= 1);
                                    r = a(n);
                                    break;
                                case 2:
                                    return "";
                            ...
                            for (e[3] = r, m = r, k.push(r); ; ) {
                                if (s.index > b) return "";
                                for (n = 0, p = Math.pow(2, i), q = 1; q != p; ) (o = s.val & s.position), (s.position >>= 1), 0 == s.position && ((s.position = c), (s.val = d(s.index++))), (n |= (o > 0 ? 1 : 0) * q), (q <<= 1);
                                switch ((r = n)) {
                                    case 0:
                                        for (n = 0, p = Math.pow(2, 8), q = 1; q != p; ) (o = s.val & s.position), (s.position >>= 1), 0 == s.position && ((s.position = c), (s.val = d(s.index++))), (n |= (o > 0 ? 1 : 0) * q), (q <<= 1);
                                        (e[h++] = a(n)), (r = h - 1), g--;
                                ...
                                if ((0 == g && ((g = Math.pow(2, i)), i++), e[r])) j = e[r];
                                else {
                                    if (r !== h) return null;
                                    j = m + m.charAt(0);
                                }
                                k.push(j), (e[h++] = m + j.charAt(0)), g--, (m = j), 0 == g && ((g = Math.pow(2, i)), i++);
                            }
                        },
                    };
                return f;
            ...
            return a.document.ui.extend("dots", {
                ...
                initialize: function () {
                    (a.preventBlur = !0),
                        ...
                        a.on("commandExecuted", this.updateUIPosition.bind(this)),
                        a.on("mousemove", d(this.mousemoveHandler.bind(this), 50)),
                        ...
                        a.on("selectionchange", d(this.highlight.bind(this), 100)),
                ...
                render: function () {
                    (this.el.innerHTML = "<span></span><span></span><span></span>"), this.ui.el.appendChild(this.el);
                },
                handleKeyup: function (b) {
                    return this.editor.context.ancestorElement.textContent.length ? void (32 !== b.keyCode && this.editor.selection.range.collapsed && this.hide()) : this.show();
                },
                updateState: function () {
                    this.updateUIPosition(), this.editor.context.properties.hidesCursor ? this.highlightAll() : this.resetHighlight();
                },
                mousemoveHandler: function (b) {
                    if (this.editor.isActive()) return this.show();
                },
                hide: function () {
                    this.visible && (this.el.classList.add("fk-hide"), this.el.classList.remove("fk-show")), (this.visible = !1);
                },
                show: function (b) {
                    !this.visible && this.document.activeEditor && this.editor.context.closestElementWithRules && (this.el.classList.add("fk-show"), this.el.classList.remove("fk-hide"), (this.visible = !0));
                },
                highlight: function (b, c) {
                    if (this.editor.context.properties.hidesCursor) return this.highlightAll();
                    if (!this.blockHighlight) {
                        var d = c.collapsed;
                        c.collapsed || this.show(),
                            this.el.classList.toggle("fk-start", !d && this.editor.selection.reachesStart(this.editor.context.ancestorElement)),
                            this.el.classList.toggle("fk-end", !d && this.editor.selection.reachesEnd(this.editor.context.ancestorElement)),
                            this.el.classList.toggle("fk-partial", !d);
                    }
                },
                resetHighlight: function () {
                    this.el.classList.remove("fk-active", "fk-partial", "fk-start", "fk-end");
                },
                ...
                handleClick: function (c) {
                    ...
                    return (
                        ...
                        "full" === this.editor.selection.getType()
                            ? (a.selection.placeCaret(d, { at: "end" }), this.resetHighlight())
                            : void ("<br>" !== d.innerHTML && (this.editor.selection.selectNode(e), this.editor.updateContext(e), this.highlightAll()))
                    );
                },
                updateUIPosition: function () {
                    if (this.editor.context.ancestorElement) {
                        0 === a.context.ancestorElement.textContent.length && this.show();
                        var c = g(this.editor.context.properties.hidesCursor ? this.editor.context.closestElementWithRules : this.editor.context.ancestorElement),
                            d = this.editor.context.properties.hidesCursor;
                        (c.left = c.left < 6 ? 6 : c.left), (this.el.style.top = c.top - (d ? 6 : 0) + "px"), (this.el.style.left = c.left + "px");
                    }
                },
            });
        }),
    ...
    function (a, b, c) {
        ...
        (l.prototype.init = function (a) {
            (this.ui = a.document.ui),
                ...
                this.editor.on("resize", d(this.updateUIPosition.bind(this), 10)),
            ...
            (l.prototype.updateUIPosition = function () {
                ...
                (this.el.style.left = a.left + "px"), (this.el.style.top = a.top + "px");
            }),
            (l.prototype.loadCommand = function (a) {
                this.hide(),
                    setTimeout(
                        function () {
                            var b = this.buttons[a].command(this.editor.context.closestElementWithRules, this.editor);
                            b instanceof HTMLElement && this.ui.focusComponent(b);
                        }.bind(this),
                        125
                    );
            }),
            ...
            (l.prototype.highlight = function (a) {
                ...
                this.selectionIndex = "prev" === a ? (0 === this.selectionIndex ? this.buttons.length - 1 : this.selectionIndex - 1) : this.selectionIndex < this.buttons.length - 1 ? this.selectionIndex + 1 : 0;
                for (var c = this.el.querySelectorAll(".fk-button--inlineMenu"), d = 0; d < c.length; d++) c[d].classList.remove(b);
                this.buttons[this.selectionIndex].el.querySelector(".fk-button--inlineMenu").classList.add(b);
            }),
                    ...
                    e(
                        function () {
                            j(this.editor.context.closestElementWithRules),
                                ...
                                document.documentElement.classList.add("fk-inline-menu"),
                                this.updateUIPosition(),
                                this.el.classList.add("fk-show"),
                                this.buttons[0].el.querySelector(".fk-button--inlineMenu").classList.add("fk-button--focused");
                        }.bind(this)
                    );
            }),
            (l.prototype.cancel = function () {
                this.hide(), this.ui.focusComponent(this.editor.context.closestElementWithRules);
            }),
            (l.prototype.hide = function () {
                ...
                a && a.classList.remove("fk-inlineMenu-offCanvas"), this.editor.emit("inlineMenuHide", this);
            }),
            ...
            (l.prototype.registerButton = function (a, b) {
                (b.name = a), (b.icon = b.hasOwnProperty("icon") ? b.icon : b.name), this.buttons.push(b);
            }),
                ...
                if (this.visible)
                    switch (a.keyCode) {
                        case f.backspace:
                            ...
                            break;
                        case f.enter:
                            a.preventDefault(), this.loadCommand(this.selectionIndex);
                            break;
                        case f.arrowLeft:
                        ...
                        case f.arrowDown:
                            ...
                            break;
                        case f.tab:
                            return a.preventDefault(), a.shiftKey ? this.highlightPrev() : this.highlightNext();
                        default:
                    ...
                    var c = b === f.space,
                        d = this.editor.context.closestElementWithRules;
                    if ((c || "mousedown" === a.type || "touchstart" === a.type) && "H1,H2,H3,H4,H5,H6,P,BLOCKQUOTE".indexOf(d.tagName) > -1 && 0 === d.textContent.length)
                        return d.classList.add("fk-inlineMenu-offCanvas"), a.preventDefault(), this.editor.emit("inlineMenuOpen", this), this.show();
                }
            }),
            (a.exports = l);
    },
    function (a, b, c) {
        ...
        var d = c(356),
            e = c(239),
            f = function (b, c) {
                var f = '<div title="<%= title %>" class="fk-button fk-button--inlineMenu fk-ui-icon-<%= icon %>"></div>';
                return e(
                    {
                        type: "command",
                        name: "undefined",
                        ...
                        __initialize: function (e) {
                            return (
                                ...
                                this.el.firstChild.addEventListener("touchstart", function (a) {
                                    a.stopPropagation(), a.preventDefault(), c.loadCommand(e);
                                }),
                                this.el.firstChild.addEventListener("click", c.loadCommand.bind(c, e)),
                                this
                            );
                        },
                    },
    ...
    function (a, b, c) {
        function u(a, b, c) {
            ...
            var y,
                ...
                B = b.interpolate || s,
                C = "__p += '",
                D = RegExp((b.escape || s).source + "|" + B.source + "|" + (B === l ? r : s).source + "|" + (b.evaluate || s).source + "|$", "g"),
                E = "sourceURL" in b ? "//# sourceURL=" + b.sourceURL + "\n" : "";
            ...
            var F = b.variable;
            F || (C = "with (obj) {\n" + C + "\n}\n"),
                (C = (z ? C.replace(o, "") : C).replace(p, "$1").replace(q, "$1;")),
                (C =
                    "function(" +
                    (F || "obj") +
                    ") {\n" +
    ...
    function (a, b, c) {
        function i(a) {
            if (!e(a)) return !1;
            var b = d(a);
            return b == h || b == g || ("string" == typeof a.message && "string" == typeof a.name && !f(a));
        }
        var d = c(12),
            e = c(16),
            f = c(361),
    ...
    function (a, b, c) {
        var d = c(366),
            ...
            f = c(370),
            g = c(364),
            h = { escape: e, evaluate: f, interpolate: g, variable: "", imports: { _: { escape: d } } };
        a.exports = h;
    },
    function (a, b, c) {
        function h(a) {
    ...
    function (a, b, c) {
        ...
        (o.prototype.init = function (a) {
            a.behaviors.register("deleteCheckbox", e),
                ...
                a.registerNormalization("modifiedNodes", "ensureDeletedChecklist", n),
                a.on("click", function (b) {
                    var c = b.target.classList.contains("checklist__item__box");
                    c && (b.preventDefault(), a.commands.execute("toggleCheckbox", c));
                }),
                a.on("contextChange", function (b) {
                    if (b && "LI" === b.tagName && b.classList.contains("checklist__item")) {
                        var c = b.querySelector(".checklist__item__text");
                        c && (a.selection.placeCaret(c, { at: "start" }), a.updateContext(c));
                    }
                });
        }),
            (a.exports = o);
        ...
        function c(a, b, c) {
            if (0 === b.textContent.length || c.selection.isFirstCharacter(b)) {
                ...
                if (((h = h.length ? h : ""), e.matches(":first-child"))) {
                    ...
                    return (i.innerHTML = h), c.dom.insertBefore(i, d), c.selection.placeCaret(i, { at: "start" }), 0 === d.childElementCount && d.parentNode.removeChild(d), c.updateContext(i);
                }
                if (g) {
                    "<br>" === g.innerHTML && f.removeChild(f.firstElementChild), c.selection.placeCaret(g, { at: "end" });
                    var j = document.createElement("div");
                    for (j.innerHTML = h.replace("<br>", ""); j.firstChild; ) g.appendChild(j.firstChild);
    ...
    function (a, b) {
        ...
        function c(a, b, c) {
            ...
            if (d.textContent.length) {
                ...
                (e.innerHTML = c.selection.extractContentAfterCaret(b)), 0 === b.textContent.length && (b.innerHTML = "<br>"), (e = e.textContent.length ? e.innerHTML : "<br>");
                var f = document.createElement("li");
                (f.className = d.className), f.classList.remove("checklist__item--checked"), (f.innerHTML = d.innerHTML);
            ...
            for (i.classList.add("checklist"); f; ) i.appendChild(f), (f = d.nextElementSibling);
            c.dom.insertAfter(i, d.closest("ul")), c.dom.insertAfter(h, d.closest("ul")), c.selection.placeCaret(h), d.parentNode.removeChild(d);
        }
        a.exports = c;
    },
    function (a, b) {
        ...
        function c(a, b, c) {
            var d = c.dom.getPrevCursorTarget(b);
            d && c.selection.isFirstCharacter(b) && (a.preventDefault(), c.selection.placeCaret(d, { at: "end" }));
        }
        a.exports = c;
    },
    function (a, b) {
        ...
        function c(a, b, c) {
            var d = c.dom.getNextCursorTarget(b);
            d && c.selection.isLastCharacter(b) && (a.preventDefault(), c.selection.placeCaret(d, { at: "start" }));
        }
        a.exports = c;
    },
    function (a, b) {
        ...
        function c(a, b, c) {
            ...
            if ((c.selection.isLastCharacter(b) || !b.textContent.length) && d) {
                a.preventDefault();
                for (var e = d.querySelector(".checklist__item__text"); e.firstChild; ) b.appendChild(e.firstChild);
                var f = b.querySelector("br");
                b.textContent.length && f && f.parentNode.removeChild(f), d.parentNode.removeChild(d);
            }
        }
        a.exports = c;
    },
    function (a, b) {
        ...
        var c = {
            ...
            execute: function () {
                var b = this;
                if (this.context.ancestorElement.classList.contains("checklist")) {
                    var c = this.context.closestElementWithRules.closest("li"),
                        d = function a(b) {
                            for (var c = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1]; c ? b.nextElementSibling : b.previousElementSibling; )
                                if (((b = c ? b.nextElementSibling : b.previousElementSibling), !b.classList.contains("checklist__item--checked"))) return b;
                            return !!c && a(b, !1);
                        };
                    if (this.selection.range.collapsed) {
                        c.classList.contains("checklist__item--checked") || this.commands.execute("toggleCheckbox", c.querySelector(".checklist__item__box"));
                        var e = d(c);
                        if (e) {
                            var f = e.querySelector(".checklist__item__text");
                            this.selection.placeCaret(f, { at: "start" }), this.updateContext(f);
                        }
                    }
                    var g = [].slice.call(this.context.ancestorElement.querySelectorAll(".checklist__item--checked"));
                    if (
                        (g.forEach(function (a) {
                            ...
                            (a.style.height = c.height + "px"),
                                ...
                                setTimeout(function () {
                                    a.parentNode && (a.parentNode.removeChild(a), a === g[g.length - 1] && b.emit("commandExecuted", { type: "blur" }));
                                }, 1e3);
                        }),
                        !this.context.ancestorElement.querySelector("li:not(.checklist__item--hide)"))
                    ) {
                        var h = document.createElement("p");
                        (h.innerHTML = "<br>"), this.dom.replaceElement(this.context.ancestorElement, h), this.emit("inlineMenuHide"), this.updateContext(h);
                    }
                    return !0;
                }
            },
    ...
    function (a, b) {
        ...
        var c = {
            execute: function () {
                var b = document.createElement("ul");
                if ((b.classList.add("checklist"), !this.context.ancestorElement.classList.contains("checklist")))
                    return (
                        [].slice.call(this.context.ancestorElement.children).forEach(function (a) {
                            var c = document.createElement("li");
                            (c.className = "checklist__item " + a.className),
                                (c.innerHTML = '<span contenteditable="false" class="checklist__item__box"></span><div class="checklist__item__text">' + a.innerHTML + "</div>"),
                                b.appendChild(c);
                        }),
                        this.dom.replaceElement(this.context.ancestorElement, b),
                        b
            ...
            queryState: function () {
                return this.context.ancestorElement.classList.contains("checklist");
            },
        };
        a.exports = c;
    },
        ...
        var c = {
            ...
            execute: function () {
                var b = "checklist__item--checked",
                    c = function (b) {
                        return null === b.className.match(/l[0-9]/g) ? -1 : b.className.match(/l[0-9]/g).length;
                    },
                    d = function a(b, d) {
                        var e = d || b;
                        return !!b.previousElementSibling && (c(b.previousElementSibling) < c(e) ? b.previousElementSibling : a(b.previousElementSibling, e));
                    },
                    e = function a(b, d) {
                        for (var e = d || [], f = c(b), g = b; g; ) (g.classList.contains("l0") && 1 === f) || (g.classList.contains("l1") && 2 === f) ? (e.push(g), (g = d ? g.previousElementSibling : g.nextElementSibling)) : (g = null);
                        return d || e.join(a(b, e)), e;
                    },
                    f = function (b) {
                        return b.nextElementSibling && c(b.nextElementSibling) > c(b) ? e(b.nextElementSibling) : [];
                    },
                    g = function a(f) {
                        var g = { i: -1, checked: -1 },
                        ...
                        h.forEach(function (a) {
                            (g.i += 1), (g.checked += a.classList.contains(b) ? 1 : 0);
                        }),
                            d(f) && (d(f).classList.toggle(b, g.i === g.checked), a(d(f)));
                    };
                if (this.context.closestElementWithRules.classList.contains("checklist__item__text") || this.context.closestElementWithRules.classList.contains("checklist__item__box")) {
            ...
            var b = "checklist__item__box",
                ...
                f = function (f) {
                    var g = f.classList.contains(e),
                        h = f.parentNode && f.parentNode.classList.contains("checklist");
                    if ((f.firstChild && "BR" === f.firstChild.tagName && f.firstChild.parentNode.removeChild(f.firstChild), g)) {
                        if (!h) return void f.classList.remove("checklist__item");
                        var i = f.querySelector("span." + b);
                        return i ? i.setAttribute("contentEditable", !1) : f.insertBefore(d(), f.firstChild);
                    }
                    if (h && !g) {
                        f.classList.add(e);
                        var j = document.createElement("div");
                        for (j.className = c; f.firstChild; ) j.appendChild(f.firstChild);
    ...
    function (a, b) {
        ...
        var c = function () {
            ...
            return (b.className = "checklist__item__box"), (b.contentEditable = !1), b;
        };
        a.exports = c;
    },
    function (a, b, c) {
        ...
        function e(a) {
            ...
            if (a && 1 === a.childElementCount && !b.textContent.length && a.classList.contains("checklist")) {
                var c = b.querySelector(".checklist__item__text"),
                    e = b.querySelector(".checklist__item__box");
                if (!c) {
                    var f = document.createElement("div");
                    for (f.classList.add("checklist__item__text"); b.firstElementChild; ) f.appendChild(b.firstElementChild);
                    b.appendChild(f);
                }
        ...
        (f.prototype.init = function (a) {
            ...
            (f.prototype.createMarkup = function () {
                (this.hostEl = document.createElement("div")),
                    (this.hostEl.innerHTML = '<div class="notification__content">' + this.config.text + '</div><div class="notification__button">' + this.config.button + "</div>"),
                    this.hostEl.classList.add("notification"),
                    (this.buttonEl = this.hostEl.querySelector(".notification__button")),
                    (this.contentEl = this.hostEl.querySelector(".notification__content"));
            }),
            (f.prototype.show = function (a) {
                var b = this;
                (this.config = d({ text: "Hello…", id: !1, button: "Got it!", callback: function () {} }, a)),
                    this.createMarkup(),
                    ("true" === localStorage.getItem("n" + a.id) && this.config.id) || (this.hostEl.classList.add("show"), document.querySelector("aside").appendChild(this.hostEl)),
                    this.buttonEl.addEventListener("click", function () {
                        b.config.id && localStorage.setItem("n" + a.id, "true"), b.buttonEl.classList.add("active"), b.hostEl.classList.remove("show"), b.config.callback();
                    });
            }),
            (a.exports = f);
    },
